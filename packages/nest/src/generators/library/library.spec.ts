...
describe('lib', () => {
   ...
   describe('not nested', () => {
      ...
      it('should include a controller', async () => {
         ...
         expect(
            tree.exists(`my-lib/src/lib/my-lib.controller.ts`)
         ).toBeTruthy();
      });
   ...
   describe('nested', () => {
      ...
      it('should create a local tsconfig.json', async () => {
         ...
         expect(
            readJson(tree, `my-dir/my-lib/tsconfig.json`)
         ).toMatchSnapshot();
      });
   });
   ...
   describe('--simpleName', () => {
      it('should generate a library with a simple name', async () => {
         ...
         expect(
            tree.exists('api/my-lib/src/lib/my-lib.module.ts')
         ).toBeTruthy();

         expect(
            tree.exists('api/my-lib/src/lib/my-lib.service.ts')
         ).toBeTruthy();
