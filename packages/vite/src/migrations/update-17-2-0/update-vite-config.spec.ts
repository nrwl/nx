...
describe('change-vite-ts-paths-plugin migration', () => {
   ...
   it('should add build outDir to vite.config.ts if build exists', async () => {
      ...
      expect(
         readProjectConfiguration(tree, 'demo2').targets.build.options
            .outputPath
      ).toBe('dist/demo2');
   });
   ...
   it('should add file replacements to vite.config.ts', async () => {
      ...
      expect(
         readProjectConfiguration(tree, 'demo3').targets.build.options
            .outputPath
      ).toBe('dist/demo3');
   });
   ...
   it('should convert the file correctly', async () => {
      ...
      expect(
         readProjectConfiguration(tree, 'demo4').targets.build.options
            .outputPath
      ).toBe('dist/demo4');
   });
