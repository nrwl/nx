      ...
      compiler.hooks.thisCompilation.tap(pluginName, (compilation) => {
         compilation.hooks.processAssets.tap(
            ...
            () => {
               ...
               const importHelpers = !!readTsConfig(this.options.tsConfig)
                  .options.importHelpers;
               ...
               const packageJson = createPackageJson(
                  ...
                  this.options.projectGraph,
                  {
                     ...
                     isProduction: true,
                     helperDependencies: helperDependencies.map(
                        (dep) => dep.target
                     ),
                  }
               );
               packageJson.main =
                  packageJson.main ?? this.options.outputFileName;
