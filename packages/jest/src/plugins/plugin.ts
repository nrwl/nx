 ...
 * @returns the deducted group name or `E2E (CI)` if cannot be deducted automatically
 */
function deductGroupNameFromTarget(ciTargetName: string | undefined) {
  ...
  return 'E2E (CI)'; // default group name when cannot be deducted from target name
}
