    ...
    it('should setup cypress correctly for vite', async () => {
      ...
      expect(appTree.read('my-app-e2e/cypress.config.ts', 'utf-8'))
        ...
        export default defineConfig({
          e2e: { ...nxE2EPreset(__filename, {"cypressDir":"src","bundler":"vite","webServerCommands":{"default":"nx run my-app:serve","production":"nx run my-app:preview"},"ciWebServerCommand":"nx run my-app:serve-static"}),
