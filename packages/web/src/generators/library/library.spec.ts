...
describe('lib', () => {
  ...
  describe('not nested', () => {
    ...
    it('should generate files', async () => {
      ...
      expect(appTree.exists('libs/my-lib/src/lib/hello.spec.ts')).toBeTruthy();
    });
  });
  ...
  describe('nested', () => {
    ...
    it('should generate files', async () => {
      ...
      expect(
        appTree.exists('libs/my-dir/my-lib/src/lib/hello.ts')
      ).toBeTruthy();
      expect(
        appTree.exists('libs/my-dir/my-lib/src/lib/hello.spec.ts')
      ).toBeTruthy();
    });
