...
describe('app', () => {
   ...
   describe('not nested', () => {
      it('should create project configs', async () => {
         ...
         expect(
            readProjectConfiguration(appTree, 'my-app-e2e')
         ).toMatchSnapshot();
      });
   ...
   describe('nested', () => {
      ...
      it('should generate files', async () => {
         ...
         expect(appTree.read(appModulePath, 'utf-8')).toContain(
            'class AppModule'
         );
   ...
   describe('--style scss', () => {
      it('should generate scss styles', async () => {
         ...
         expect(appTree.exists('my-app/src/app/app.component.scss')).toEqual(
            true
         );
      });
   });
   ...
   describe('--style sass', () => {
      it('should generate sass styles', async () => {
         ...
         expect(appTree.exists('my-app/src/app/app.component.sass')).toEqual(
            true
         );
      });
   });
   ...
   describe('--style less', () => {
      it('should generate less styles', async () => {
         ...
         expect(appTree.exists('my-app/src/app/app.component.less')).toEqual(
            true
         );
      });
   });
   ...
   describe('--backend-project', () => {
      describe('with a backend project', () => {
         it('should add a proxy.conf.json to app', async () => {
            ...
            expect(
               appTree.read('customer-ui/proxy.conf.json', 'utf-8')
   ...
   describe('--strict', () => {
      ...
      it('should set defaults when --strict=false', async () => {
         ...
         const nxJson = readJson<NxJsonConfiguration>(appTree, 'nx.json');
         expect(nxJson.generators['@nx/angular:application'].strict).toBe(
            false
         );
      });
   });
   ...
   describe('--standalone', () => {
      it('should generate a standalone app correctly with routing', async () => {
         ...
         // ASSERT
         expect(
            appTree.read('standalone/src/main.ts', 'utf-8')
         ).toMatchSnapshot();
         expect(
   ...
   describe('--project-name-and-root-format=derived', () => {
      it('should generate correctly when no directory is provided', async () => {
         ...
         expect(
            appTree.exists('apps/my-app/src/app/app.module.ts')
         ).toBeTruthy();
         expect(
         ...
         expect(eslintrcJson.extends).toEqual(['../../.eslintrc.json']);
         expect(
            appTree.exists('apps/my-app-e2e/cypress.config.ts')
         ).toBeTruthy();
         const tsconfigE2E = parseJson(
      ...
      it('should generate correctly when directory is provided', async () => {
         ...
         expect(
            appTree.exists('apps/my-dir/my-app/jest.config.ts')
         ).toBeTruthy();
