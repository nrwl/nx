...
describe('lib', () => {
   ...
   describe('not nested', () => {
      ...
      it('should check for existence of spec files before deleting them', async () => {
         ...
         // ASSERT
         expect(
            tree.read('my-lib/src/lib/my-lib.component.spec.ts')
         ).toBeFalsy();
      ...
      it('should generate files', async () => {
         ...
         expect(
            tree.exists('my-lib/src/lib/my-lib.service.spec.ts')
         ).toBeFalsy();
         ...
         expect(
            tree.exists('my-lib2/src/lib/my-lib2.component.ts')
         ).toBeFalsy();
         expect(
   ...
   describe('at the root', () => {
      ...
      it('should generate files with correct output paths', async () => {
         ...
         expect(tree.read(libModulePath, 'utf-8')).toContain(
            'class MyLibModule'
         );
   ...
   describe('router', () => {
      it('should error when lazy is set without routing', async () => {
         // ACT & ASSERT
         await expect(
            runLibraryGeneratorWithOpts({ lazy: true })
         ).rejects.toThrow(
   ...
   describe('--unit-test-runner none', () => {
      it('should not generate test configuration', async () => {
         ...
         // ASSERT
         expect(
            tree.exists('my-lib/src/lib/my-lib.module.spec.ts')
         ).toBeFalsy();
   ...
   describe('--standalone', () => {
      ...
      it('should generate a library with a standalone component in a directory', async () => {
         ...
         expect(
            tree.read(
               'my-dir/my-lib/src/lib/my-lib/my-lib.component.ts',
               'utf-8'
            )
         ).toMatchSnapshot();
         expect(
   ...
   describe('--project-name-and-root-format=derived', () => {
      it('should generate correctly when no directory is provided', async () => {
         ...
         expect(
            tree.exists('libs/my-lib/src/lib/my-lib.module.ts')
         ).toBeTruthy();
      });
