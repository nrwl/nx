...
describe('add-template-support-and-presets-to-eslint', () => {
  describe('tslint-only workspace', () => {
    ...
    it('should do nothing', async () => {
      const packageJsonBefore = readJsonInTree(tree, 'package.json');
      ...
      expect(packageJsonBefore).toEqual(readJsonInTree(result, 'package.json'));
    });
  });
  ...
  describe('workspace with at least one eslint project', () => {
    ...
    it(`should update the workspace package.json if they are using the latest eslint config from Nx`, async () => {
      ...
      expect(readJsonInTree(result, 'package.json')).toMatchInlineSnapshot(`
        Object {
          "dependencies": Object {
            "@angular/core": "11.0.0",
          },
    ...
    it(`should update any relevant project .eslintrc.json files`, async () => {
      ...
      writeJsonInTree(tree, 'apps/app1/.eslintrc.json', {
        rules: {},
      });
      writeJsonInTree(tree, 'libs/lib1/.eslintrc.json', {
        rules: {},
      });
      ...
      expect(readJsonInTree(result, 'apps/app1/.eslintrc.json'))
      ...
      expect(readJsonInTree(result, 'libs/lib1/.eslintrc.json'))
        .toMatchInlineSnapshot(`
        Object {
          "extends": "../../.eslintrc.json",
          "ignorePatterns": Array [
