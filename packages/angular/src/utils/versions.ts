...
export const angularVersion = '~17.1.0-next.3';
export const angularDevkitVersion = '~17.1.0-next.1';
export const ngPackagrVersion = '~17.1.0-next.2';
...
export const browserSyncVersion = '^2.29.3';
