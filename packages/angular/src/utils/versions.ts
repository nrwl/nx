...
export const angularVersion = '~22.1.0';
export const angularDevkitVersion = '~22.1.0';
export const ngPackagrVersion = '~22.1.0';
export const ngrxVersion = '^22.0.0';
...
export const angularEslintVersion = '^22.1.0';
