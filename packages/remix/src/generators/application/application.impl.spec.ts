   ...
   describe('Standalone Project Repo', () => {
      ...
      describe(`--js`, () => {
         it('should create the application correctly', async () => {
            ...
            expect(
               tree.read('app/routes/_index.js', 'utf-8')
            ).toMatchSnapshot();
         });
      });
      ...
      describe('--e2eTestRunner', () => {
         it('should generate a cypress e2e application for the app', async () => {
            ...
            expect(
               tree.read('e2e/cypress.config.ts', 'utf-8')
            ).toMatchSnapshot();
         });
      });
      ...
      it('should generate a playwright e2e application for the app', async () => {
         ...
         expect(
            tree.read('e2e/playwright.config.ts', 'utf-8')
         ).toMatchSnapshot();
      });
   });
   ...
   describe.each([
      ...
      (projectNameAndRootFormat: ProjectNameAndRootFormat, appDir, e2eDir) => {
         it('should create the application correctly', async () => {
            ...
            expect(
               tree.read(`${appDir}/app/root.tsx`, 'utf-8')
            ).toMatchSnapshot();
            expect(
         ...
         describe('--js', () => {
            it('should create the application correctly', async () => {
               ...
               expect(
                  tree.read(`${appDir}/app/root.js`, 'utf-8')
               ).toMatchSnapshot();
               expect(
