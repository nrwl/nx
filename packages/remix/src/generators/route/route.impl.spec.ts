   ...
   describe.each([
      ...
      (
         ...
         it('should succeed if skipChecks flag is passed, and it detects a possible missing route param because of un-escaped dollar sign', async () => {
            ...
            expect(
               tree.exists(
                  'apps/demo/app/routes/path/to/example/route2/index.tsx'
               )
            ).toBe(true);
    ...
    module.exports = {
      ...
      appDirectory: "my-custom-dir",
               ...
               expect(
                  tree.exists('apps/demo/my-custom-dir/routes/route.tsx')
               ).toBe(true);
               expect(
                  tree.exists('apps/demo/my-custom-dir/styles/route.css')
               ).toBe(true);
            });
         }
