...
export const DETOX_EXECUTORS_DEPRECATION_MESSAGE =
  '`@nx/detox:build` and `@nx/detox:test` are deprecated and will be removed in Nx v24. Run `nx g @nx/detox:convert-to-inferred` to migrate to the `@nx/detox/plugin` inferred targets. See https://nx.dev/technologies/test-tools/detox/guides/convert-to-inferred for details.';
