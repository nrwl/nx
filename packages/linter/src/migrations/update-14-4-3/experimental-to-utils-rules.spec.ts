...
describe('experimentalToUtilsUpdate()', () => {
  ...
  it('should switch import from @typescript-eslint/experimental-utils to @typescript-eslint/utils in rule file', async () => {
  ...
  it('should switch import from @typescript-eslint/experimental-utils to @typescript-eslint/utils in spec file', async () => {
    await experimentalToUtilsUpdate(tree);
