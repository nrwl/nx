...
class GetExternalDepFromInputFileTest {
    ...
    fun testExternalDepFromInputFile() {
        ...
        val result = getExternalDepFromInputFile(
                "org.apache.commons/commons-lang3/3.13.0/b7263237aa89c1f99b327197c41d0669707a462e/commons-lang3-3.13.0.jar",
                externalNodes
        )
        assertEquals(externalNodes.toString(), "{gradle:commons-lang3-3.13.0=ExternalNode(type=gradle, name=gradle:commons-lang3-3.13.0, data=ExternalDepData(version=3.13.0, packageName=org.apache.commons.commons-lang3, hash=b7263237aa89c1f99b327197c41d0669707a462e))}")
    }
}
