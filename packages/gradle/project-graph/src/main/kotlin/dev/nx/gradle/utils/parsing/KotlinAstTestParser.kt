 ...
 * kotlin-compiler-embeddable available. Combines environment creation, parsing, and cleanup. Only
 * accepts/returns JDK and Gradle API types so no compiler types cross the classloader boundary.
 */
fun parseKotlinFileViaAst(
    file: File,
