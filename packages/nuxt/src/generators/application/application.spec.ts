      ...
      (name: string) => {
         describe('general application', () => {
            ...
            it('should configure vitest correctly', () => {
               ...
               expect(
                  tree.read(`${name}/tsconfig.json`, 'utf-8')
               ).toMatchSnapshot();
            ...
            it('should configure tsconfig and project.json correctly', () => {
               expect(
                  tree.read(`${name}/project.json`, 'utf-8')
               ).toMatchSnapshot();
               expect(
                  tree.read(`${name}/tsconfig.json`, 'utf-8')
               ).toMatchSnapshot();
         ...
         describe('styles setup', () => {
            ...
            it('should configure css', async () => {
               ...
               expect(
                  tree.exists('myapp1/src/assets/css/styles.css')
               ).toBeTruthy();
               expect(
                  tree.read('myapp1/nuxt.config.ts', 'utf-8')
               ).toMatchSnapshot();
            });
            ...
            it('should configure scss', async () => {
               ...
               expect(
                  tree.exists('myapp2/src/assets/css/styles.scss')
               ).toBeTruthy();
               expect(
                  tree.read('myapp2/nuxt.config.ts', 'utf-8')
               ).toMatchSnapshot();
            });
            ...
            it('should configure less', async () => {
               ...
               expect(
                  tree.exists('myapp3/src/assets/css/styles.less')
               ).toBeTruthy();
               expect(
                  tree.read('myapp3/nuxt.config.ts', 'utf-8')
               ).toMatchSnapshot();
            });
            ...
            it('should not configure styles', async () => {
               ...
               expect(
                  tree.exists('myapp4/src/assets/css/styles.css')
               ).toBeFalsy();
               expect(
                  tree.read('myapp4/nuxt.config.ts', 'utf-8')
               ).toMatchSnapshot();
            });
         });
      }
