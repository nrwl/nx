...
describe('babel-plugin-reactive', () =>
{
    ...
    describe('@InputProperty decorator', () =>
    {
        it('should transform @InputProperty to simple getter/setter', () =>
        {
            const code = `
                import { Component, InputProperty } from '@fluffjs/fluff';
                ...
                export class MyComponent extends HTMLElement {
                    @InputProperty() deviceProperty = null;
                }
            `;
            ...
            expect(result).toContain('__deviceProperty');
            expect(result).toContain('get deviceProperty()');
            expect(result).toContain('set deviceProperty(');
            expect(result).not.toContain('getValue()');
            expect(result).not.toContain('setValue(');
        });

        it('should inject @Watch method calls into @InputProperty setter', () =>
        {
            const code = `
                import { Component, InputProperty, Watch } from '@fluffjs/fluff';
            ...
            expect(result).toBeDefined();
            expect(result).toContain('this.onPropertyChange("deviceProperty")');
        });

        it('should check for value change before calling watch method', () =>
        {
            const code = `
                import { Component, InputProperty, Watch } from '@fluffjs/fluff';
            ...
            expect(result).toContain('__v !== this.__prop');
        });

        it('should inject $watch callback into @InputProperty setter', () =>
        {
            const code = `
                import { Component, InputProperty } from '@fluffjs/fluff';
                ...
                export class MyComponent extends HTMLElement {
                    ...
                    private subscription = this.$watch(['deviceProperty'], (prop) => {
                        console.log('property changed');
                    });
                }
            `;
