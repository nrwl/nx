...
public class TargetBuilderAtomizerTests
{
    ...
    {
        // Regression test. This bail-out used to be silent: the project would
        // simply not split with no explanation, unlike the two sibling gates
        // (unsupported platform, no parser available) which both say exactly
        // why splitting isn't happening.
        var properties = new Dictionary<string, string>
        {
