...
/// the cost of one documented blind spot: tests inherited from a base class.
/// <c>#if</c> regions are evaluated against the project's own DefineConstants,
/// so they resolve the way the build resolves them.
///
