...
export const CYPRESS_EXECUTOR_DEPRECATION_MESSAGE =
  'The `@nx/cypress:cypress` executor is deprecated and will be removed in Nx v24. Run `nx g @nx/cypress:convert-to-inferred` to migrate to the `@nx/cypress/plugin` inferred targets. See https://nx.dev/technologies/test-tools/cypress/guides/convert-to-inferred for details.';
