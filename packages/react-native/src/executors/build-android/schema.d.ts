...
export interface ReactNativeBuildAndroidOptions
  ...
  /**
   * @deprecated, use tasks instead. e.g. tasks=['bundleRelease'] for aab, and tasks=['assembleRelease'] for apk. Will be removed in nx 16.
   */
  apk?: boolean;
  /**
   * @deprecated, use mode='debug' instead. Will be removed in nx 16.
   */
  debug?: boolean;
  /**
   * @deprecated, use tasks instead instead. Will be removed in nx 16.
   */
  gradleTask?: string;
