...
*  [&lt;feature&gt;.init.ts](#featureinitts)
*  [&lt;feature&gt;.interfaces.ts](#featureinterfacests)
...
/**
 * Interface to the part of the Store containing Products
 */
...
export function <feature>Reducer(state: <Feature> = initialState, action: <Feature>Actions): <Feature> {
 switch (action.type) {
