   ...
   describe('shared options', () => {
      ...
      describe('nested', () => {
         ...
         it('should update root tsconfig.base.json', async () => {
            ...
            expect(
               tsconfigJson.compilerOptions.paths['my-lib/*']
            ).toBeUndefined();
         });
      ...
      describe('--importPath', () => {
         it('should update the tsconfig with the given import path', async () => {
            ...
            expect(
               tsconfigJson.compilerOptions.paths['@myorg/lib']
            ).toBeDefined();
         });
         ...
         it('should read import path from existing name in package.json', async () => {
            ...
            const tsconfigJson = readJson(tree, '/tsconfig.base.json');
            expect(
               tsconfigJson.compilerOptions.paths['@acme/core']
            ).toBeDefined();
         });
      });
      ...
      describe('--pascalCaseFiles', () => {
         ...
         it('should generate files with upper case names for nested libs as well', async () => {
            ...
            expect(
               tree.exists('my-dir/my-lib/src/lib/MyLib.spec.ts')
            ).toBeTruthy();
         });
      });
   });
