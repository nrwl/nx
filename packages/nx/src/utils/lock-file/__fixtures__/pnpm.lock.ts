...
export const lockFileWithInlineSpecifiers = `lockfileVersion: 5.4-inlineSpecifiers
...
export const lockFileWithInlineSpecifiersAndWorkspaces = `lockfileVersion: 5.4-inlineSpecifiers
...
packages:
  ...
  /@yarnpkg/parsers/3.0.0-rc.29:
    resolution: {integrity: sha512-07kAB4mEcZltoMBQqV4Tb8ucCpOQCG6fl4fH/2cmOU8Nh6nZcmvCptIuARC5dd4vfZKI5zUUoK2arR+pOi9PxQ==}
    engines: {node: '>=14.15.0'}
    dependencies:
      js-yaml: 3.14.1
      tslib: 2.4.1
