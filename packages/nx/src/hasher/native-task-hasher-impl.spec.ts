      ...
      [
        {
          "details": {
            ...
            "workspace:[{workspaceRoot}/.env,{workspaceRoot}/.env.local,{workspaceRoot}/.local.env,{workspaceRoot}/nx.json,{workspaceRoot}/.gitignore,{workspaceRoot}/.nxignore]": "18099427347122160586",
          },
    ...
    expect(hash).toMatchInlineSnapshot(`
      {
        "details": {
          ...
          "parent:ProjectConfiguration": "3608670998275221195",
          "parent:TsConfig": "2264969541778889434",
          "workspace:[{workspaceRoot}/.env,{workspaceRoot}/.env.local,{workspaceRoot}/.local.env,{workspaceRoot}/nx.json,{workspaceRoot}/.gitignore,{workspaceRoot}/.nxignore]": "11114659294156087056",
        },
      ...
      [
        {
          "details": {
            ...
            "parent:TsConfig": "2264969541778889434",
            "parent:{projectRoot}/**/*": "17059468255294227635",
            "workspace:[{workspaceRoot}/.env,{workspaceRoot}/.env.local,{workspaceRoot}/.local.env,{workspaceRoot}/nx.json,{workspaceRoot}/.gitignore,{workspaceRoot}/.nxignore]": "12076281115618125366",
            "workspace:[{workspaceRoot}/global1]": "14542405497386871555",
            "workspace:[{workspaceRoot}/global2]": "12932836274958677781",
          },
          "value": "11429369354799582104",
        },
      ]
    `);
  });
