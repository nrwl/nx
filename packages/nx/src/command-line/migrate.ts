...
const LEGACY_NRWL_PACKAGE_GROUP: ArrayPackageGroup = [
  ...
  { package: '@nx/angular', version: '*' },
  { package: '@nx/cypress', version: '*' },
  { package: '@nx/devkit', version: '*' },
  { package: '@nrwl/eslint-plugin-nx', version: '*' },
  { package: '@nrwl/express', version: '*' },
  { package: '@nx/jest', version: '*' },
  { package: '@nx/linter', version: '*' },
  { package: '@nrwl/nest', version: '*' },
  { package: '@nx/next', version: '*' },
  { package: '@nrwl/node', version: '*' },
  { package: '@nrwl/nx-plugin', version: '*' },
  { package: '@nx/react', version: '*' },
  { package: '@nx/storybook', version: '*' },
  { package: '@nx/web', version: '*' },
  { package: '@nx/js', version: '*' },
  { package: 'nx-cloud', version: 'latest' },
  { package: '@nx/react-native', version: '*' },
