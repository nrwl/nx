...
export const examples: Record<string, Example[]> = {
  ...
  migrate: [
    ...
    },
    {
      ...
      description:
        "Collect package updates and migrations in interactive mode. In this mode, the user will be prompted whether to apply any optional package update and migration. Deprecated and slated for removal in Nx v24 - use '--mode' instead.",
    },
    {
