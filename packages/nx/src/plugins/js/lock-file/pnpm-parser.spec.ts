...
snapshots:
  ...
  describe('alias-first-party', () => {
    ...
    it('should handle first-party aliases (root package.json)', () => {
      ...
      // BUG: "string-width" is a direct dependency in package.json but gets NO node on the graph.
      // The alias "another-string-width" (which resolves to the same version) overwrites it.
      // Maybe lines 374-382 of pnpm-parser.ts where alias overwrites rootDependencyName? Need more investigation.
      expect(externalNodes).toMatchInlineSnapshot(`
        {
          ...
          "npm:another-string-width@string-width@5.1.2": {
            "data": {
              "hash": "sha512-HnLOCR3vjcY8beoNLtcjZ5/nxn2afmME6lhrDrebokqMap+XbeW8n9TXpPDOqdGK5qcI3oT0GKTW6wC7EMiVqA==",
              "packageName": "another-string-width",
              "version": "string-width@5.1.2",
            },
            "name": "npm:another-string-width@string-width@5.1.2",
            "type": "npm",
          },
          ...
          "npm:string-width-cjs@string-width@4.2.3": {
            "data": {
              "hash": "sha512-wKyQRQpjJ0sIp62ErSZdGsjMJWsap5oRNihHhu6G7JVO/9jIB6UyevL+tXuOqrng8j/cxKTWyWUwvSTriiZz/g==",
              "packageName": "string-width-cjs",
              "version": "string-width@4.2.3",
            },
            "name": "npm:string-width-cjs@string-width@4.2.3",
            "type": "npm",
          },
          "npm:strip-ansi@6.0.1": {
            "data": {
