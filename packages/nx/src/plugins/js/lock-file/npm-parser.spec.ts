...
describe('NPM lock file utility', () => {
  ...
  describe('transitive workspace dependencies', () => {
    ...
    it('should link a workspace alias entry at the root to the target module', () => {
      ...
      // Preserve the input specifier for the executor's post-stringification
      // alias rewrite.
    ...
    it('should walk transitive deps of a workspace package referenced only through an alias in a v1 lock file', () => {
      // npm v1 keys this node by alias, leaving no canonical snapshot for
      ...
      // Supply lib-b's manifest edge because alias-keyed npm v1 lock data omits it.
