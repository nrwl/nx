...
describe('getNonDummyDeps', () => {
  ...
  describe('dependents', () => {
    it('should handle simple reverse dependency', () => {
      ...
      // lib2:destroy should run before lib1:destroy (since lib1 depends on lib2)
      expect(taskGraph).toEqual({
        roots: ['lib2:destroy'],
        tasks: {
          'lib2:destroy': {
    ...
    it('should handle multiple dependents', () => {
      ...
      // lib1:destroy should run before both lib2:destroy and lib3:destroy
      ...
      expect(taskGraph.dependencies['lib3:destroy']).toEqual(['lib1:destroy']);
    });
    ...
    it('should handle multi-level reverse dependencies', () => {
      ...
      expect(taskGraph.roots).toEqual(['lib2:destroy']);
      expect(taskGraph.dependencies['lib2:destroy']).toEqual([]);
      expect(taskGraph.dependencies['lib1:destroy']).toEqual(['lib2:destroy']);
      expect(taskGraph.dependencies['app1:destroy']).toEqual(['lib1:destroy']);
    });
    ...
    it('should handle mix of dependencies and dependents', () => {
      ...
      // Destroying: lib2:destroy runs before lib1:destroy (reverse dependency)
      ...
      expect(destroyGraph.roots).toEqual(['lib2:destroy']);
