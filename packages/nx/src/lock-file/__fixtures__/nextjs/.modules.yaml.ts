...
hoistedDependencies:
  ...
  /@cypress/webpack-preprocessor/5.15.7_lxwsdojuovvngvdkxl6v3c5p3q:
    '@cypress/webpack-preprocessor': private
  ...
  /@yarn-tool/resolve-package/1.0.47:
    '@yarn-tool/resolve-package': private
  ...
  /rollup-plugin-copy/3.4.0:
    rollup-plugin-copy: private
  /rollup-plugin-peer-deps-external/2.2.4_rollup@2.79.1:
    rollup-plugin-peer-deps-external: private
...
pendingBuilds: []
prunedAt: Tue, 03 Jan 2023 11:14:46 GMT
publicHoistPattern:
  - '*eslint*'
  - '*prettier*'
registries:
