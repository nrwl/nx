/**
 * Package.json used for generation of lockfile
 * {
 *   "name": "test",
 *   "version": "0.0.0",
 *   "license": "MIT",
...
export const npmLockFileWithAliases = `{
  ...
  "packages": {
    ...
    "node_modules/eslint-plugin-disable-autofix": {
      "name": "@mattlewis92/eslint-plugin-disable-autofix",
      "version": "3.0.0",
      "resolved": "https://registry.npmjs.org/@mattlewis92/eslint-plugin-disable-autofix/-/eslint-plugin-disable-autofix-3.0.0.tgz",
...
export const npmLockFileV1WithAliases = `{
  "name": "test",
  "version": "0.0.0",
  "lockfileVersion": 1,
  "requires": true,
