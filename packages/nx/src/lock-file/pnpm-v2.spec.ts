...
describe('pnpm LockFile utility', () => {
  it('should parse next.js starter', async () => {
    const fileSys = {
      'node_modules/@babel/preset-react/package.json': '{"version": "7.18.6"}',
      ...
      'node_modules/eslint-plugin-cypress/package.json':
        '{"version": "2.12.1"}',
      'node_modules/eslint-plugin-import/package.json': '{"version": "2.26.0"}',
      'node_modules/eslint-plugin-jsx-a11y/package.json':
        '{"version": "6.6.1"}',
      'node_modules/eslint-plugin-react/package.json': '{"version": "7.31.11"}',
      ...
      'node_modules/react-test-renderer/package.json': '{"version": "18.2.0"}',
      'node_modules/regenerator-runtime/package.json': '{"version": "0.13.7"}',
  ...
  it('should parse auxiliary packages', async () => {
    const fileSys = {
      ...
      'node_modules/eslint-plugin-disable-autofix/package.json':
        '{"version": "3.0.0"}',
      'node_modules/eslint-rule-composer/package.json': '{"version": "0.3.0"}',
      'node_modules/eslint-scope/package.json': '{"version": "7.1.1"}',
      'node_modules/eslint-utils/package.json': '{"version": "3.0.0"}',
      'node_modules/eslint-visitor-keys/package.json': '{"version": "3.3.0"}',
