...
export declare class AppLifeCycle {
  ...
  registerRunningTask(taskId: string, parserAndWriter: ExternalObject<[ParserArc, WriterArc]>, taskKiller: ExternalObject<KillerArc>): void
  __setCloudMessage(message: string): Promise<void>
}

export declare class ChildProcess {
  getParserAndWriter(): ExternalObject<[ParserArc, WriterArc]>
  getKiller(): ExternalObject<KillerArc>
  kill(): void
