...
function requireNative() {
  if (process.platform === 'android') {
    if (process.arch === 'arm64') {
      ...
      try {
        return require('nx-android-arm64')
      } catch (e) {
        loadErrors.push(e)
      }
      ...
      try {
        return require('nx-android-arm-eabi')
      } catch (e) {
        loadErrors.push(e)
      }
    ...
    if (process.arch === 'x64') {
      ...
      try {
        return require('nx-win32-x64-msvc')
      } catch (e) {
        loadErrors.push(e)
      }
      ...
      try {
        return require('nx-win32-ia32-msvc')
      } catch (e) {
        loadErrors.push(e)
      }
      ...
      try {
        return require('nx-win32-arm64-msvc')
      } catch (e) {
        loadErrors.push(e)
      }
    ...
    try {
      ...
      try {
        return require('nx-darwin-universal')
      } catch (e) {
        loadErrors.push(e)
      }
    ...
    if (process.arch === 'x64') {
      ...
      try {
        return require('nx-darwin-arm64')
      } catch (e) {
        loadErrors.push(e)
      }
    ...
    if (process.arch === 'x64') {
      ...
      try {
        return require('nx-freebsd-arm64')
      } catch (e) {
        loadErrors.push(e)
      }
    ...
    if (process.arch === 'x64') {
      ...
      try {
        return require('nx-linux-x64-musl')
      } catch (e) {
        loadErrors.push(e)
      }
      ...
      try {
        return require('nx-linux-x64-gnu')
      } catch (e) {
        loadErrors.push(e)
      }
      ...
      try {
        return require('nx-linux-arm64-musl')
      } catch (e) {
        loadErrors.push(e)
      }
      ...
      try {
        return require('nx-linux-arm64-gnu')
      } catch (e) {
        loadErrors.push(e)
      }
      ...
      try {
        return require('nx-linux-arm-gnueabihf')
      } catch (e) {
        loadErrors.push(e)
      }
      ...
      try {
        return require('nx-linux-riscv64-musl')
      } catch (e) {
        loadErrors.push(e)
      }
      ...
      try {
        return require('nx-linux-riscv64-gnu')
      } catch (e) {
        loadErrors.push(e)
      }
      ...
      try {
        return require('nx-linux-s390x-gnu')
      } catch (e) {
        loadErrors.push(e)
      }
...
if (!nativeBinding || process.env.NAPI_RS_FORCE_WASI) {
  ...
  if (!nativeBinding) {
    try {
      nativeBinding = require('nx-wasm32-wasi')
    } catch (err) {
      if (process.env.NAPI_RS_FORCE_WASI) {
        console.error(err)
      }
