...
const { expandOutputs, getFilesForOutputs, remove, copy, hashArray, hashFile, hashFiles, ImportResult, findImports, TaskErrors, HashPlanner, EventType, Watcher, WorkspaceContext, WorkspaceErrors } = nativeBinding
...
module.exports.TaskErrors = TaskErrors
