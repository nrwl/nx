...
pub fn get_event_dimensions() -> EventDimensions {
    EventDimensions {
        ...
        multi_major_source: event_dimension::MULTI_MAJOR_SOURCE.to_string(),
        ...
        error_code: event_dimension::ERROR_CODE.to_string(),
        ...
        prompt: event_dimension::PROMPT.to_string(),
        choice: event_dimension::CHOICE.to_string(),
