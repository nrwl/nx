...
pub fn connect_to_nx_db(
    ...
    let c = initialize_db(nx_version, &db_path).inspect_err(|_| unlock_file(&lock_file))?;
...
fn initialize_db(nx_version: String, db_path: &PathBuf) -> anyhow::Result<NxDbConnection> {
