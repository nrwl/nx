...
(async () => {
    ...
    try {
        if (isMainNxPackage() && (0, fileutils_js_1.fileExists)((0, path_1.join)(workspace_root_js_1.workspaceRoot, 'nx.json'))) {
            (0, assert_supported_platform_js_1.assertSupportedPlatform)();
            if ((0, nx_cloud_utils_js_1.isNxCloudUsed)((0, nx_json_js_1.readNxJson)())) {
                await (0, update_manager_js_1.verifyOrUpdateNxCloudClient)((0, get_cloud_options_js_1.getCloudOptions)());
            }
        }
    }
    catch (e) {
        ...
        const end = new Date();
        logger_js_1.logger.verbose(`Nx postinstall steps took ${end.getTime() - start.getTime()}ms`);
