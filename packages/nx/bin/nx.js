...
async function main() {
    ...
    const workspace = (0, find_workspace_root_js_1.findWorkspaceRoot)(process.cwd());
    if (workspace) {
...
function resolveNx(workspace) {
    ...
    try {
        return require.resolve('nx/bin/nx.js', {
            paths: [(0, installation_directory_js_1.getNxInstallationPath)(workspace ? workspace.dir : globalsRoot)],
        });
    }
    catch { }
...
function getLocalNxVersion(workspace) {
    try {
        const { packageJson } = (0, package_json_js_1.readModulePackageJson)('nx', (0, installation_directory_js_1.getNxRequirePaths)(workspace.dir));
