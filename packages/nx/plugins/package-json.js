...
const cachePath = (0, path_1.join)(
  cache_directory_js_1.workspaceDataDirectory,
  'package-json.hash'
);
...
const plugin = {
  ...
  createNodesV2: [
    ...
    (configFiles, options, context) => {
      ...
      const isInPackageJsonWorkspaces = (0,
      index_js_2.buildPackageJsonWorkspacesMatcher)(
        context.workspaceRoot,
        (f) =>
          (0, fileutils_js_1.readJsonFile)(
            (0, path_1.join)(context.workspaceRoot, f)
          )
      );
      const result = (0, index_js_1.createNodesFromFiles)(
        (packageJsonPath) =>
          (0, index_js_2.createNodeFromPackageJson)(
            packageJsonPath,
            workspace_root_js_1.workspaceRoot,
            cache,
