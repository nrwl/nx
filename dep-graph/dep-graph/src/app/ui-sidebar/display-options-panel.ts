...
export class DisplayOptionsPanel {
    ...
    render.innerHTML = `
        <div>
          <div class="mt-8 px-4">
            ...
            <button type="button" class="hidden mt-3 w-full flex items-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50" data-cy="deselectAllButton">
              <svg xmlns="http://www.w3.org/2000/svg" class="-ml-1 mr-2 h-5 w-5 text-gray-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  render(container: HTMLElement) {
    ...
    selectAllButtonElement.addEventListener('click', () => {
      ...
      selectAllButtonElement.classList.add('hidden');
      deselectAllButtonElement.classList.remove('hidden');
    });
    ...
    deselectAllButtonElement.addEventListener('click', () => {
      ...
      deselectAllButtonElement.classList.add('hidden');
      selectAllButtonElement.classList.remove('hidden');
    });
