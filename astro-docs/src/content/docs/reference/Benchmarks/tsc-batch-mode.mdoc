...
![Side by side demo of normal tsc taking 1m48s and batch mode tsc taking 28s](/img/ts-benchmark.gif)
...
{% github_repository url="https://github.com/nrwl/large-ts-monorepo" /%}

{% aside type="note" title="Potential speed improvement" %}
...
- [Enable Typescript Batch Mode](/docs/technologies/typescript/guides/enable-tsc-batch-mode)
