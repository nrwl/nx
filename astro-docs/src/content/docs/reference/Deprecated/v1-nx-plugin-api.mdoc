...
This API has been superceded by the [v2 API](/docs/extending-nx/project-graph-plugins) and will be removed in Nx 20. If targeting Nx version 16.7 or higher, please use the v2 API instead.
{% /aside %}
...
- [createNodes](/docs/extending-nx/project-graph-plugins#adding-new-nodes-to-the-project-graph)
- [createDependencies](/docs/extending-nx/project-graph-plugins#adding-new-dependencies-to-the-project-graph)
...
For guidance on implementing a similar function in the v2 API, see the documentation on [createNodes](/docs/extending-nx/project-graph-plugins#example-extending-projects-adding-inferred-targets).
...
{% github_repository url="https://github.com/nrwl/nx-go-project-graph-plugin" /%}
