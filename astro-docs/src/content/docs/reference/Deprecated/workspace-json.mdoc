...
Identifying the locations of projects is now done automatically through project inference. You can even customize how projects are inferred with a [project inference plugin](/docs/extending-nx/project-graph-plugins).
...
See [fix-configuration](/docs/reference/workspace/generators#fix-configuration) for more options.
