...
Instead of specifying the runtime inputs in `tasksRunnerOptions`, in Nx 14.4 you can include them as runtime inputs in the standard [`inputs` and `namedInputs` area of your project configuration](/docs/reference/project-configuration#inputs-and-named-inputs) or [`nx.json`](/docs/reference/nx-json#inputs-namedinputs).
