...
![Step 3](../../../../assets/enterprise/single-tenant/github_auth_step_3.png)

And create a new OAuth app:

![Step 4](../../../../assets/enterprise/single-tenant/github_auth_step_4.png)
...
![Step 5](../../../../assets/enterprise/single-tenant/github_auth_step_5.png)

Once you create, keep a note of the Client ID:

![Step 6](../../../../assets/enterprise/single-tenant/github_auth_step_6.png)
