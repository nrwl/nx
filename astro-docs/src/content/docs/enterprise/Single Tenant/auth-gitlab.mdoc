...
![Step 1](../../../../assets/enterprise/single-tenant/gitlab_step_1.png)

Then "Applications" from the left-hand menu:

![Step 2](../../../../assets/enterprise/single-tenant/gitlab_step_2.png)
...
![Step 3](../../../../assets/enterprise/single-tenant/gitlab_step_3.png)

Ensure you grant it the "`read_user`" scope:

![Step 4](../../../../assets/enterprise/single-tenant/gitlab_step_4.png)

Click "Save application".

Once you create, keep a note of the Client ID and the Secret:

![Step 5](../../../../assets/enterprise/single-tenant/gitlab_step_5.png)
