...
Teach you to use this tool to explore projects, the project graph, and the task graphs for your workspace.
...
The view shows a list of targets which can be [run by Nx](/docs/features/run-tasks).
