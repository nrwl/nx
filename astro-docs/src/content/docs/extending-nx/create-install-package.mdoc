...
_(If you don't have such a `local-registry` target, refer to the following [docs page to generate one](/docs/technologies/typescript/generators#setup-verdaccio))_
...
- [Blog post: Create your own create-react-app CLI](https://nx.dev/blog/create-your-own-create-react-app-cli)
