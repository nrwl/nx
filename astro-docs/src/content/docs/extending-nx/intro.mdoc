...
Nx core functionality focuses on task running and understanding your project and task graph. Nx plugins leverage that functionality to enforce best practices, seamlessly integrate tooling and allow developers to get up and running quickly.
...
You can find more helper functions in the [Nx Devkit reference documentation](/docs/reference/devkit).
