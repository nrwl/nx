...
description: Learn how to bypass Nx caching mechanism for specific tasks, skip remote caching from Nx Cloud, and reset the cache when needed.
filter: 'type:Guides'
---

There are times when you might want to bypass the [caching mechanism](/docs/features/cache-task-results), either locally or remotely.
...
To clear the cache and metadata about the workspace and shuts down the Nx Daemon you can use the [reset](/docs/reference/nx-commands#nx-reset) command:
