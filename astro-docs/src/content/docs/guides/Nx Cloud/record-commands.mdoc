...
2. Prefix your command with `npx nx record --`, or the appropriate execute command of your package manager. The `--` is optional but makes it easier to read what portion of the command will be recorded. (example: npx nx record -- echo "hello world")
...
![npx nx record -- echo "hello world"](../../../../assets/nx-cloud/set-up/record-hello-world.webp)
...
![nx record -- nx format:check](https://nx.dev/nx-cloud/set-up/record-format-check.webp)
