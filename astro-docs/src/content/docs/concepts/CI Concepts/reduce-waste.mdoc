...
For this discussion, we'll assume you understand the Nx [mental model](/docs/concepts/mental-model) and have an understanding of both [what the affected command is](/docs/features/ci-features/affected) and [how caching works](/docs/concepts/how-caching-works).
