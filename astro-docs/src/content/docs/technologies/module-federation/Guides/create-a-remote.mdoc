...
```text {% title="nx g @nx/react:remote --name=myremote" frame="terminal" %}
...
```text {% title="nx g @nx/angular:remote apps/angular/myremote" frame="terminal" %}
...
```typescript
// apps/react/shell/module-federation.config.js
module.exports = {
  name: 'shell',
  remotes: ['myremote'], // <-- add the name of your remote to the remotes array
};
...
the [create a host guide](/docs/technologies/module-federation/guides/create-a-host) for more information on how to achieve
this.
{% /aside %}
...
```text {% title="nx g @nx/react:remote apps/react/myremote --host=shell" frame="terminal" %}
NX  Generating @nx/react:remote
...
```text {% title="nx g @nx/angular:remote apps/angular/myremote --host=shell" frame="terminal" %}
> NX Generating @nx/angular:host
