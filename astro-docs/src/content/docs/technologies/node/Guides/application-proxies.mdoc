...
Webpack dev-server has built-in support for [proxies](https://webpack.js.org/configuration/dev-server/#devserverproxy).
...
Vite server has built-in support for [proxies](https://vite.dev/config/server-options#server-proxy).
