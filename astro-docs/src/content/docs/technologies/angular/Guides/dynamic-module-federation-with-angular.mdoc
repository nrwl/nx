...
The terminal examples will show `nx` being run as if it is installed globally. If you have not installed Nx globally (not required), you can use your package manager to run the `nx` local binary:
...
In the next section, we will see how Nx generators can be used to automate a lot of this process for us!
