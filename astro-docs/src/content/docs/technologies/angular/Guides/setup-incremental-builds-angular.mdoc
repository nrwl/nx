...
We'll specifically look into which changes need to be made to enable incremental builds for Angular
applications.
...
{% aside type="caution" title="More details" %}
...
{% aside type="note" title="Angular Esbuild Performance" %}
...
Angular build time with Esbuild already provides a great performance boost and therefore overall time saved may not
warrant using incremental builds with Esbuild for Angular
{% /aside %}

Change your Angular application's "build" target executor to Nx version of builder you're currently using and the "
...
{% tabs %}
{% tabitem label="@angular-devkit/build-angular:application" %}
...
{% /tabitem %}
{% tabitem label="@angular-devkit/build-angular:browser-esbuild" %}
...
{% /tabitem %}
{% tabitem label="@angular-devkit/build-angular:browser" %}
...
{% tabs %}
{% tabitem label="@nx/angular:application" %}
...
{% /tabitem %}
{% tabitem label="@nx/angular:browser-esbuild" %}
...
{% /tabitem %}
{% tabitem label="@nx/angular:webpack-browser" %}
...
{% github_repository url="https://github.com/nrwl/nx-incremental-large-repo" /%}
