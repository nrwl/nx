...
{% aside type="note" title="Nx & Angular" %}
The difference between Nx Devkit and Angular Devkit. See the [Nx Devkit](/docs/reference/devkit) guide for more in-depth details about Nx Devkit.
{% /aside %}
...
Support to run Angular Devkit builders and schematics is enabled by installing the [`@nx/angular` plugin](/docs/technologies/angular/introduction). This plugin is installed by default when creating a new Angular workspace with Nx or [migrate an existing Angular CLI workspace to Nx](/docs/technologies/angular/migration/angular).
{% /aside %}
