...
When Angular switched to Esbuild, this meant that it became difficult for applications that used custom Webpack configurations to migrate to the new build system. help you migrate from Angular with Webpack to Rspack.
...
{% aside type="caution" title="Optional Step" %}
