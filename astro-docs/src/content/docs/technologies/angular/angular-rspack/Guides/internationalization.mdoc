...
description: 'Guide on how to use Angular build-time i18n with Angular Rspack'
sidebar:
  label: 'Internationalization'
filter: 'type:Guides'
---

Angular Rspack supports Angular [build-time i18n](https://angular.dev/guide/i18n) out of the box. walk you through how to use it.  
...
{% aside type="note" title="Extracting i18n messages" %}
