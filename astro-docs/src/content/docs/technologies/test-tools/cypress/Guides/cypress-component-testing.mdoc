...
Unlike [E2E testing](/docs/technologies/test-tools/cypress/introduction), component testing does not create a new project. Instead, Cypress component testing is added
directly to a project, like [Jest](/docs/technologies/test-tools/jest/introduction)

## Add component testing to a project

> Currently only [@nx/react](/docs/technologies/react/generators#cypress-component-configuration), [@nx/angular](/docs/technologies/angular/generators#cypress-component-configuration), and [@nx/next](/docs/technologies/react/next/generators#cypress-component-configuration) plugins support component testing
...
> Note: The [@nx/next:cypress-component-configuration generator](/docs/technologies/react/next/generators#cypress-component-configuration) doesn't require a build target
...
{% aside type="caution" title="Executor Options" %}
