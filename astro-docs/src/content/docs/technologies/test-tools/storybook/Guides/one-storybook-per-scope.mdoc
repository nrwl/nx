...
[Using Storybook in a Nx workspace - Best practices](/docs/technologies/test-tools/storybook/guides/best-practices) guide. It discussed the best practices of using Storybook in a Nx workspace, explaining the main concepts and the mental model of how to best set up Storybook. Now, we are going to see how to put that into practice, by looking at a real-world example. We are going to see how you can publish one Storybook per scope (eg. theme, app, framework) for your workspace.

Sometimes, you have multiple apps and libraries, and each of these is associated with a specific scope. You can read more about grouping libraries and scoping them in the [Library Types](/docs/concepts/decisions/project-dependency-rules) documentation page.
...
If we want to combine stories from different libraries in the same Storybook instance, _the stories need to use the same framework_.
