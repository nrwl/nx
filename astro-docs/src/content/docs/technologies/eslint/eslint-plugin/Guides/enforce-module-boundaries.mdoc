...
- [Ban Dependencies with Certain Tags](/docs/guides/enforce-module-boundaries/ban-dependencies-with-tags)
- [Tag in Multiple Dimensions](/docs/guides/enforce-module-boundaries/tag-multiple-dimensions)
- [Ban External Imports](/docs/guides/enforce-module-boundaries/ban-external-imports)
- [Tags Allow List](/docs/guides/enforce-module-boundaries/tags-allow-list)
- [Taming Code Organization with Module Boundaries in Nx](https://nx.dev/blog/mastering-the-project-boundaries-in-nx)
