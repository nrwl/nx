...
Alternatively, if you are on Node 20 or do not want to use Node.js strip-types feature, the `tsx` package provides fast TypeScript execution with ESM support:
