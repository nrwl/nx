      ...
      sidebar: [
        {
          ...
          items: [
            ...
            { label: 'Start a new project', link: 'getting-started/start-new-project' },
            { label: 'Add to existing project', link: 'getting-started/start-with-existing-project' },
            ...
            { label: 'AI Integration', link: 'getting-started/ai-setup' },
            {
              ...
              collapsed: true,
              items: [
                { label: 'TypeScript Monorepo', link: 'getting-started/tutorials/typescript-packages-tutorial' },
                { label: 'React Monorepo', link: 'getting-started/tutorials/react-monorepo-tutorial' },
                { label: 'Angular Monorepo', link: 'getting-started/tutorials/angular-monorepo-tutorial' },
                { label: 'Gradle Monorepo', link: 'getting-started/tutorials/gradle-tutorial' },
              ],
            },
          ],
        },
        {
          ...
          items: [
            ...
            { label: 'Maintain TypeScript Monorepos', link: 'features/maintain-ts-monorepos' },
            { label: 'Automate Updating Dependencies', link: 'features/automate-updating-dependencies' },
            { label: 'Enforce Module Boundaries', link: 'features/enforce-module-boundaries' },
            { label: 'Manage Releases', link: 'features/manage-releases' },
            {
              label: 'CI Features',
              collapsed: true,
              items: [
                { label: 'AI-Powered Self-Healing CI', link: 'ci/features/self-healing-ci' },
                { label: 'Use Remote Caching (Nx Replay)', link: 'ci/features/remote-cache' },
                { label: 'Distribute Task Execution (Nx Agents)', link: 'ci/features/distribute-task-execution' },
                { label: 'Run Only Tasks Affected by a PR', link: 'ci/features/affected' },
                { label: 'Dynamically Allocate Agents', link: 'ci/features/dynamic-agents' },
                { label: 'Automatically Split E2E Tasks', link: 'ci/features/split-e2e-tasks' },
                { label: 'Identify and Re-run Flaky Tasks', link: 'ci/features/flaky-tasks' },
              ],
            },
          ],
        },
          ...
          items: [
            {
              ...
              collapsed: true,
              items: [
                { label: 'Introduction', link: 'technologies/typescript/introduction' },
                {
                  label: 'Guides',
                  collapsed: true,
            ...
            },
            {
              ...
              collapsed: true,
              items: [
                { label: 'Introduction', link: 'technologies/module-federation/introduction' },
                {
                  label: 'Guides',
                  collapsed: true,
                  autogenerate: { directory: 'technologies/module-federation/guides' },
                },
                {
                  label: 'API',
                  collapsed: true,
            ...
            },
            {
              ...
              collapsed: true,
              items: [
                { label: 'Introduction', link: 'technologies/build-tools/introduction' },
                {
                  label: 'Guides',
                  collapsed: true,
            ...
            },
            {
              ...
              collapsed: true,
              items: [
                { label: 'Introduction', link: 'technologies/test-tools/introduction' },
                {
                  label: 'Guides',
                  collapsed: true,
        ...
        },
        {
          ...
          items: [
            ...
            { label: 'Project Configuration', link: 'reference/project-configuration' },
        ...
        },
        {
          ...
          items: [
            { label: 'Resolve Circular Dependencies', link: 'troubleshooting/resolve-circular-dependencies' },
            { label: 'Troubleshoot Nx Install Issues', link: 'troubleshooting/troubleshoot-nx-install-issues' },
            { label: 'Troubleshoot Cache Misses', link: 'troubleshooting/troubleshoot-cache-misses' },
            { label: 'Unknown Local Cache Error', link: 'troubleshooting/unknown-local-cache' },
            { label: 'Profiling Build Performance', link: 'troubleshooting/performance-profiling' },
            { label: 'Troubleshoot Nx Console Issues', link: 'recipes/nx-console/console-troubleshooting' },
            { label: 'Troubleshoot Convert to Inferred Migration', link: 'troubleshooting/convert-to-inferred' },
          ],
        },
      ],
    }),
