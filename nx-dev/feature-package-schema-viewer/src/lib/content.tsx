...
export function Content({
   ...
   return (
      ...
      >
            ...
            <div className="my-6 block rounded-md bg-red-50 p-4 ring-1 ring-red-100 dark:bg-red-900/30 dark:ring-red-900">
               <div className="flex">
                  ...
                  <div className="ml-3">
                     ...
                     <p className="prose-sm mt-2 block text-red-700 dark:text-red-600">
                        Please do not extend this schema as it is part of Nx
                        internal usage.
                     </p>
                  </div>
               </div>
         ...
         {schemaViewModel.type === 'executor' &&
            !schemaViewModel.subReference && (
               <div className="mt-8 hidden md:block">
                  <Heading2 title="Options playground" />
                  <p className="my-6">
                     Try out this interactive editor of the configuration
                     object. Values are validated as you type and hovering over
                     labels will give you more information.
                  </p>
                  {!!schemaViewModel.currentSchema.presets.length && (
                     <>
                        <Heading3 title="Examples" />
                        <p className="my-4">
                           These buttons show the config object for specific
                           common tasks.
                        </p>
                        <div className="mb-4 flex flex-wrap gap-4">
                           ...
                           {!!presets.length && (
                              ...
                              >
                                 Reset{' '}
                                 <XCircleIcon className="ml-1.5 h-4 w-4" />
                              </button>
                           )}
                        </div>
                     </>
