   ...
   if (type !== undefined) {
      if (type === 'boolean') {
         ...
         if (itemSchema === undefined) {
            ...
            if (
               typeof chosenItem !== 'boolean' &&
               chosenItem.$ref !== undefined
            ) {
         ...
         const match = (schema.examples || []).find(
            (x) => typeof x === 'object'
         );
         if (match !== undefined) {
            return Example.of(match);
            ...
            const props = Object.keys(properties)
               ...
               .map<NameAndExample | IgnoredProperty>((name) => {
                  ...
                  if (prop === undefined) {
                     return {
                        name,
                        example: Errors.of(missingSchema(propOrRef)),
                     };
                  }
                  ...
                  if (
                     isErrors(generatedExample) &&
                     !requiredPropNames.has(name)
                  ) {
                     return { name };
                  }
