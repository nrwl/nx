...
export const champions1: Champion[] = [
  ...
  },
  {
    ...
    imageUrl: '/images/champions/jay-bell.webp',
    contact: [
      {
        label: '@JayCooperBell',
  ...
  },
  {
    ...
    imageUrl: '/images/champions/jorge-cano.webp',
    contact: [
      {
        label: '@jorgeucano',
  ...
  },
  {
    ...
    expertise:
      '🅰️ Mentor / Angular Architect - 📖 DDD & Nx / @AngularWroclaw - Organizer / Angular Bros - Co-Founder / Host of Angular Tech X Spaces',
...
export const champions2: Champion[] = [
  ...
  },
  {
    ...
    imageUrl: '/images/champions/tine-kondo.webp',
    contact: [
      {
        label: '@tinesoft',
      ...
      },
      {
        ...
        link: 'mailto:kondotine@gmail.com',
      },
    ],
    location: 'Luxembourg',
  },
...
export const champions3: Champion[] = [
  ...
  },
  {
    ...
    contact: [
      {
        label: '@ParanoidCoder',
        link: 'https://x.com/ParanoidCoder',
      },
    ],
