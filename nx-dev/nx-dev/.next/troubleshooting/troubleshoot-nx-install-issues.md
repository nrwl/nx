...
{% aside type="note" title="Updating Nx" %}
...
For issues inside VSCode or Nx Console, also refer to the [Nx Console troubleshooting docs](/docs/guides/nx-console/console-troubleshooting)
