...
![Step 1](../../../../assets/enterprise/single-tenant/bitbucket_onprem_1.png)

Then "Application Links":

![Step 2](../../../../assets/enterprise/single-tenant/bitbucket_onprem_2.png)

And create a new link using the settings below (make sure the callback URL is pointed to your BitBucket installation):

![Step 3](../../../../assets/enterprise/single-tenant/bitbucket_onprem_3.png)
