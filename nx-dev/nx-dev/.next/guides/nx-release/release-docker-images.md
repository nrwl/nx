...
## Create basic Node.js backend {% badge text="optional" /%}
...
Dry run your first Docker release with calendar versioning. See the [`nx release`](/docs/reference/nx-commands#nx-release) CLI reference for all available options.
...
By default, Nx Release uses the following patterns for calendar versioning
...
{% aside title="Default Versioning Schemes" type="note" %}
