...
A powerful feature of Nx Release is the fact that it is designed to be used via a Node.js programmatic API in addition to the [`nx release`](/docs/reference/nx-commands#nx-release) CLI.
