...
If you wish to bypass the versioning prompt, you can configure Nx Release to defer to the [Conventional Commits](https://www.conventionalcommits.org/en/v1.0.0/) standard to determine the version bump automatically. This is useful for automating the versioning process in a CI/CD pipeline. See the [`nx release version`](/docs/reference/nx-commands#nx-release-version) CLI reference for all available versioning options.
