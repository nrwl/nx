...
In addition to the `withNx` composable plugin, Nx provides other composable plugins such as `withWeb`, `withReact`, and `withModuleFederation`. You can read more about how these plugins work and how to use them in our [Webpack plugins guide](/docs/technologies/build-tools/webpack/guides/webpack-plugins).
...
{% tabs %}
{% tabitem label="Basic Webpack configuration" %}
...
{% /tabitem %}
{% tabitem label="Nx-enhanced Webpack configuration" %}
...
If you use the [Module Federation](/docs/technologies/module-federation/concepts/faster-builds-with-module-federation) support
