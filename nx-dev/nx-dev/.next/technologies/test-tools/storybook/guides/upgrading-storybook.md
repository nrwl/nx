...
Nx provides migration support for major Storybook versions (8, 9, and 10). You can upgrade using Nx built-in migration system or the Storybook CLI directly.
