  ...
  The @nx/detox plugin provides various executors to help you create and configure detox projects within your Nx workspace.
...
| Option | Type | Description | Default |
|--------|------|-------------|---------|
| `detoxConfiguration` | string [**required**] | Select a device configuration from your defined configurations, if not supplied, and there's only one configuration, detox will default to it. |  |
