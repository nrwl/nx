...
Using this package for Nx Module Federation support keeps our support aligned with the latest improvements, features and bug fixes for Module Federation.
...
Follow our [How to Create a Remote Application Recipe](/docs/technologies/module-federation/guides/create-a-remote) to learn more.
...
Follow our [How to Create a Host Application Recipe](/docs/technologies/module-federation/guides/create-a-host) to learn more.
...
Follow our [How to Federate a Module Recipe](/docs/technologies/module-federation/guides/federate-a-module) to learn more.
