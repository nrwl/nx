...
**Note:** The `@craco/craco` package allows us to customize the webpack and jest config without ejecting. You may need to also install `@craco/craco` globally, if you see that your build fails.
