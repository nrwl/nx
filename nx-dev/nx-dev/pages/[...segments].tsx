      ...
      >
        <div className="flex items-center justify-center min-h-screen">
          ...
          <div className="z-50 bg-white rounded w-11/12 max-w-xl filter drop-shadow-2xl">
            ...
            <div className="my-5 p-5 w-full grid grid-cols-1 lg:grid-cols-3 gap-3 justify-items-center">
              <Link href={`${version.id}/react${router.asPath}`}>
                <a className="w-6/12 lg:w-full bg-white border border-gray-100 shadow-sm hover:shadow-md transition-all ease-out duration-180 rounded py-4 px-3 space-x-1 text-base tracking-tight font-bold leading-tight text-center flex flex-col justify-center items-center px-2 py-4 space-y-4">
