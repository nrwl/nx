...
const tips: NewYearTip[] = [
   {
      ...
      cardBack: (
         <FlipCardBack>
            ...
            <p className="my-4">
               Are you just getting started with Nx? Or do you need a succinct
               way of explaining Nx to your colleagues?
            </p>
            <p className="my-4">
               Read more in our{' '}
               <Link
   ...
   },
   {
      ...
      cardBack: (
         <FlipCardBack>
            ...
            <p className="my-4">
               Nx can provide benefits no matter how your repository is
               organized. It helps to have terms to describe different kinds of
               repositories.
            </p>
            <p className="my-4">
               Read more in our{' '}
   ...
   },
   {
      ...
      cardBack: (
         <FlipCardBack>
            ...
            <p className="my-4">
               Nx does not just enable you to manage your repo even as it scales
               to a large monorepo - it also makes your CI fast. With features
               like remote caching, distributed task execution,{' '}
               <Link
      ...
      cardBack: (
         <FlipCardBack>
            ...
            <p className="my-4">
               ...
               application independently. Nx helps you to set them up in a
               structured way.
            </p>
            <p className="my-4">
               Read more about how to set up{' '}
   ...
   },
   {
      ...
      cardBack: (
         <FlipCardBack>
            ...
            <p className="my-4">
               Nx can work with any technology stack and we have created
               examples for many of them.
            </p>
   ...
   },
   {
      ...
      cardBack: (
         <FlipCardBack>
            ...
            <p className="my-4">
               If you maintain a framework, open source library, or starter
               repo, you can use Nx to allow your users to quickly create a new
               repo and keep their existing repo up to date with the changes
               that you make.
            </p>
            <p className="my-4">
   ...
   },
   {
      ...
      cardBack: (
         <FlipCardBack>
            ...
            <p className="my-4">
               With Nx Agents, you allow Nx Cloud to manage your agent machines
               in CI for you. Along with that convenience, Nx Agents also offer
               dynamic scaling, automatic task splitting and flaky task
               re-running.
            </p>
            <p className="my-4">
               Currently in private beta, Nx Agents are slated for public
               release in February 2024. Don't miss the opportunity to be among
               the first to experience this groundbreaking tool.{' '}
               <Link
   ...
   },
   {
      ...
      cardBack: (
         <FlipCardBack>
            ...
            <p className="my-4">
               If you start an Nx repo with a single standalone app, you can
               easily convert it into a monorepo when you are ready to add more
               apps to the repo.
            </p>
            <p className="my-4">
   ...
   },
   {
      ...
      cardBack: (
         <FlipCardBack>
            ...
            <p className="my-4">
               Nx allows you to keep your tooling versions and configuration
               files up to date - even after breaking changes. You can think of
               it as{' '}
               <Link
            ...
            <div className="w-full bg-slate-50 py-10 dark:bg-slate-800/40 dark:text-slate-300">
               ...
               >
                  <article id="nx-new-year-tips-intro" className="relative">
                     ...
                     <p>
                        Start 2024 off right with some tips to help you get the
                        most out of Nx. Each day, a new card will be unlocked
                        for you to flip. You can{' '}
                        <a
                           className="text-slate-900 underline dark:text-slate-100"
