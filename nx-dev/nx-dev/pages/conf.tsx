                     ...
                     <div className="mt-8 flex w-full flex-col pb-10 lg:mt-0 lg:w-3/5 lg:pb-0 lg:pl-16">
                        ...
                        <h3 className="mb-6">
                           ...
                           <div className="font-input-mono text-lg">
                              <span
                                 role="img"
                                 aria-label="location pointer emoji"
                              >
                                 📍
                              </span>{' '}
                        ...
                        <p className="mb-6 sm:text-lg">
                           Nx Conf 2023 is a conference featuring members of the
                           Nx & Nx Cloud team and the community. Join us as we
                           share our ideas and expertise about monorepos and
                           making development faster, more scalable, and more
                           collaborative.
                        </p>
                        {/* <h2 className="my-6">
