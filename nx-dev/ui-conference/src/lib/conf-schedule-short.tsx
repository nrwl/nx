...
export function ConfScheduleShort(): JSX.Element {
   ...
   const scheduleItemsConference: ScheduleItem[] = [
      ...
      },
      {
         type: 'event',
         time: '10:35am',
         title: 'United by Nxcellent DX - An Nx adoption plan for migrating and onboarding hundreds of developers to an Nx monorepo',
      ...
      },
      {
         type: 'event',
         time: '2:45pm',
         title: 'Lightning Talk: What if your stories were - already - your e2e tests?',
            ...
            <div className="mx-auto max-w-screen-lg xl:max-w-screen-xl">
               <article className="md:divide-x md:divide-slate-200 md:dark:divide-slate-700">
                  <div className="px-5 py-12 md:pr-12">
                     <p className="mb-4">
                        Main conference day with speakers from the Nx core team
                        and selected community speakers.
                     </p>
                     <p className="mb-4">
                        Note: all time indications are in New York timezone
                        (UTC-04:00).
                     </p>
                  </div>
               </article>
