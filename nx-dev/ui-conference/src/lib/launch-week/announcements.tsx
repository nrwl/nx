         ...
         <section className="w-full divide-y divide-slate-200  dark:divide-slate-700">
            <article className="mx-auto max-w-screen-lg xl:max-w-screen-xl">
               <div className="px-5 py-12 md:pr-12">
                  <p>
                     We’ll be sharing new features and content daily during
                     launch week, so be sure to keep an eye on this space for
                     all the latest info!
                  </p>
               </div>
            </article>
                     ...
                     <div>
                        ...
                        <div className="mt-8 flex gap-16 font-normal">
                           <p className="max-w-xl text-lg text-slate-700 dark:text-slate-400">
                              ...
                              consistently emerged: Nx Plugins are powerful and
                              have proven to help large enterprises adopt
                              monorepos, successfully maintaining and scaling
                              them. However, there's definitely a barrier to
                              entry. So, what if Nx Plugins functioned more like
                              VSCode extensions? You simply add them, and they
                              instantly enhance the experience of working with a
               ...
               <article className="relative mx-auto max-w-screen-lg overflow-hidden pt-4 xl:max-w-screen-xl">
                  <div className="grid px-5 py-12 sm:gap-8 md:grid-cols-2 lg:py-16">
                     <div>
                        ...
                        <div className="mt-8 flex gap-16 font-normal">
                           <p className="max-w-xl text-lg text-slate-700 dark:text-slate-400">
                              Checkout the newest Nx Plugin: @nx/nuxt. We're
                              excited to collaborate closer with the Vue
                              community, and have been looking forward to
                              launching this plugin since we first announced Vue
                              support last year!
                              <br />
                              <br />
                              This is the first plugin to be created with
                              Project Crystal from day 1! Using this plugin -
                              you can expect enhanced support for the Nuxt
                              framework in Nx. It's a game changer for Nuxt
                              developers who want to take advantage of Nx's
               ...
               <article className="relative mx-auto max-w-screen-lg overflow-hidden pt-4 xl:max-w-screen-xl">
                  <div className="grid px-5 py-12 sm:gap-8 md:grid-cols-2 lg:py-16">
                     <div>
                        ...
                        <div className="mt-8 flex gap-16 font-normal">
                           <p className="max-w-xl text-lg text-slate-700 dark:text-slate-400">
                              Continuous Integration is broken, so we built Nx
                              Agents to fix it. Nx Agents is a new way to run
                              your CI/CD pipelines. It's a distributed and
                              scalable solution built to handle everything from
                              the largest enterprise monorepo, down to your
                              weekend hackathon project. It's a game changer for
                              all developers that want to focus on shipping
                              features, not maintaining CI/CD infrastructure.
                           </p>
                        </div>
                        <div className="action flex flex-col space-y-2 pt-4 sm:flex-row sm:space-x-2 sm:space-y-0">
                           <ButtonLink
               ...
               <article className="relative mx-auto max-w-screen-lg overflow-hidden pt-4 xl:max-w-screen-xl">
                  <div className="grid px-5 py-12 sm:gap-8 md:grid-cols-2 lg:py-16">
                     <div>
                        ...
                        <div className="mt-8 flex gap-16 font-normal">
                           <p className="max-w-xl text-lg text-slate-700 dark:text-slate-400">
                              Announcing Tusky: A powerful Artificial
                              Intelligence equipped with context of your
                              workspace, commit history, and historical build
                              timing data. Tusky can uniquely understand and
                              optimize your codebase and pipelines.
                           </p>
                        </div>
                        <div className="action flex flex-col space-y-2 pt-4 sm:flex-row sm:space-x-2 sm:space-y-0">
                           <ButtonLink
               ...
               <article className="relative mx-auto max-w-screen-lg overflow-hidden pt-4 xl:max-w-screen-xl">
                  <div className="grid px-5 py-12 sm:gap-8 md:grid-cols-2 lg:py-16">
                     <div>
                        ...
                        <div className="mt-8 flex gap-16 font-normal">
                           <p className="max-w-xl text-lg text-slate-700 dark:text-slate-400">
                              Last day of launch week! Releasing packages in a
                              monorepo can be tricky and many of today's tools
                              are either outdated or need further tweaking when
                              used in a monorepo. We decided to chime in and
                              leverage our experience of maintaining Lerna and
                              having hand-coded many release scripts in the past
                              to solve this once and for all. <br /> <br />
                              Check out the blog post and video below and make
                              sure to chime in for our live-stream!
                           </p>
                        </div>
                        <div className="action flex flex-col space-y-2 pt-4 sm:flex-row sm:space-x-2 sm:space-y-0">
                           <ButtonLink
