            ...
            <div className="mx-auto mt-16 max-w-2xl sm:mt-20 lg:mt-24 lg:max-w-none">
               <dl className="grid max-w-xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-3">
                  <div className="flex flex-col">
                     ...
                     <dd className="mt-1 flex flex-auto flex-col text-base leading-7">
                        <p className="flex-auto">
                           We know Nx, you know your code. Together, we can
                           build your ultimate developer platform, tailored to
                           your team.
                        </p>
                     </dd>
                  </div>
                  <div className="flex flex-col">
                     ...
                     <dd className="mt-1 flex flex-auto flex-col text-base leading-7">
                        <p className="flex-auto">
                           With the help of the developers of Nx, you'll use Nx
                           and Nx Cloud to its full potential, the first time.
                           No matter how long you've been using Nx, we'll find
                  ...
                  <div className="flex flex-col">
                     ...
                     <dd className="mt-1 flex flex-auto flex-col text-base leading-7">
                        <p className="flex-auto">
                           Wherever your team is at in their Nx journey, our
                           experts will make it easy to move ahead and capture
                           the full value of Nx and Nx Cloud.
                        </p>
                     </dd>
                  </div>
               </dl>
