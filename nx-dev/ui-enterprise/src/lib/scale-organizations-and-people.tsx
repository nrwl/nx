...
export function ScaleOrganizationsAndPeople(): JSX.Element {
  return (
    <div className="mx-auto max-w-7xl px-6 lg:px-8">
      ...
      {/* <div className="mt-16 grid grid-cols-1 items-start gap-20 sm:mt-20 lg:grid-cols-2">
        <div className="flex items-start gap-6">
          ...
          <div>
            ...
            <p className="mt-2">
              Nx Enterprise will soon support optional monorepo-like constraints
              to be applied across Nx Workspace boundaries in a seamless and
              flexible way. Teams can enjoy the benefits of atomic commits,
              single version policies, and continuous integration without
              needing to co-locate everything in a single monorepo. Move fast
              with confidence.
            </p>
          </div>
        </div>
        ...
        <div className="flex items-start gap-6">
          ...
          <div>
            ...
            <p className="mt-2">
              Nx Enterprise harnesses the power of Nx, Nx Cloud, and the Nx Team
              to enable you to build a state of the art platform for your
              developers.
            </p>
          </div>
        </div>
        <div className="flex items-start gap-6">
          ...
          <div>
            ...
            <p className="mt-2">
              ...
              Enterprise can give you the visibility you need to understand what
