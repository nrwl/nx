      ...
      <section id="scale-your-people">
         <div className="mx-auto max-w-7xl px-6 lg:px-8">
            ...
            <SectionHeading as="p" variant="subtitle" className="mt-6">
               Build big things with the efficiency of a small team by
               increasing collaboration and developer mobility, reducing wait
               time and duplication, and establishing clear ownership.
            </SectionHeading>
               ...
               <div className="space-y-6 lg:space-y-12">
                  ...
                  <div className="flex items-start gap-6">
                     ...
                     <div>
                        ...
                        <p className="mt-2">
                           Whatever you’re working with, Nx Enterprise will give
                           you the visibility you need to understand what they
                           have in common, how they relate, and how they differ.
                        </p>
                     </div>
                  </div>
                  <div className="flex items-start gap-6">
                     ...
                     <div>
                        ...
                        <p className="mt-2">
                           Nx Enterprise will support optional monorepo-like
                           constraints to be applied across Nx Workspace
                           boundaries in a seamless and flexible way. Move fast
                           with confidence.
                        </p>
                     </div>
                  </div>
                  <div className="flex items-start gap-6">
                     ...
                     <div>
                        ...
                        <p className="mt-2">
                           ...
                           Enterprise tooling instead of manual human
                           intervention to test and enforce cross-repo
