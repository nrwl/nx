      ...
      <section id="solve-your-ci">
         <div className="mx-auto max-w-7xl px-6 lg:px-8">
            ...
            <SectionHeading as="p" variant="subtitle" className="mt-6">
               ...
               challenge. Nx Enterprise solves it by providing efficient, fast
               and reliable CI that can handle workflows of any size.
            </SectionHeading>
            {/*FEATURES CONTAINER*/}
               ...
               <div className="space-y-6 lg:space-y-12">
                  <div className="flex items-start gap-6">
                     ...
                     <div>
                        ...
                        <p className="mt-2">
                           Current CI providers aren’t made for monorepos.
                           They’re low-level and static in their configuration.
                           The combination of Nx Agents and Nx Replay lets you
                           reuse computation from other runs and utilizes the
                           allocated VMs in the most optimal way.
                        </p>
                     </div>
                  </div>
                  <div className="flex items-start gap-6">
                     ...
                     <div>
                        ...
                        <p className="mt-2">
                           Atomizer splits large e2e projects into fine-grained
                           test runs, enabling more efficient distribution and
                           dramatically reducing CI times. It also identifies
                           flaky e2e tests at the file level and re-runs those
                           specific tests.
                        </p>
                     </div>
                  </div>
                  <div className="flex items-start gap-6">
                     ...
                     <div>
                        ...
                        <p className="mt-2">
                           Nx Enterprise simplifies CI configuration,
                           emphasizing which tasks to execute over how with no
                           need to tweak your CI scripts as your monorepo
                           evolves. This simplified configuration cuts down on
                           CI maintenance and increases stability.
                        </p>
                     </div>
                  </div>
               </div>
