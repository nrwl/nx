...
export function Prompt({
  ...
  return (
    <form
      ...
      className="relative mx-auto flex max-w-3xl gap-2 rounded-md border border-slate-300 bg-white py-0 px-2 shadow-lg dark:border-slate-900 dark:bg-slate-700"
    >
      <div
        className={cx(
