      ...
      <article id="contact-links" className="mx-auto max-w-7xl px-6 lg:px-8">
         <div className="grid grid-cols-1 gap-12 md:grid-cols-2 lg:grid-cols-3 lg:gap-8">
            <div>
               ...
               <p className="mt-2">
                  File a bug report, check releases or contribute to the OSS
                  products.
               </p>
               <a
            ...
            <div>
               ...
               <p className="mt-2">
                  News about Nx releases, features, new plugins, resources
            ...
            <div>
               ...
               <p className="mt-2">
                  Get an overview of Nx's features, integrations, and how to use
                  them.
               </p>
               <Link
            ...
            <div>
               ...
               <p className="mt-2">
                  Get to know the team behind Nx, Nx Cloud, Lerna and many other
