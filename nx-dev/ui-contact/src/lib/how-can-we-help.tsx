         ...
         <div className="mx-auto max-w-7xl px-6 lg:px-8">
            ...
            <div className="mx-auto mt-16 grid max-w-5xl grid-cols-1 gap-4 md:grid-cols-2">
               <section className="rounded-xl border border-slate-200 bg-slate-50/20 p-8 dark:border-slate-800/40 dark:bg-slate-800/60">
                  ...
                  <p className="mt-4">
                     Contact our sales team to discuss pricing, terms,
                     certifications, and your unique constraints.
                  </p>
                  <ButtonLink
                     href="/contact/sales"
                     variant="primary"
               ...
               <section className="rounded-xl border border-slate-200 bg-slate-50/20 p-8 md:col-span-2 dark:border-slate-800/40 dark:bg-slate-800/60">
                  ...
                  <p className="mt-4">
                     Ask a question, receive guidance, share ideas or simply
                     leave feedback about our products on the Discord channel. A
                     vibrant community of Nx users will be able to help you.
                  </p>
                  <ButtonLink
