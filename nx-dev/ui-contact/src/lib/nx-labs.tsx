      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="mx-auto mt-16 flex max-w-5xl flex-col gap-12 md:flex-row lg:gap-8">
          <section className="mt-4 flex-1">
            ...
            >
              Service built for outcomes
            </SectionHeading>
            <SectionDescription as="p" className="mt-6">
              From first steps to full adoption, our consultation, training, and
              hands-on engineering support will help your team{' '}
              <Strong>build better with Nx</Strong>.
            </SectionDescription>

            <SectionHeading
              as="p"
              variant="subtitle"
              className="mx-auto mt-8 max-w-3xl lg:pr-20"
            >
              Ready to engage Nx Labs?
            </SectionHeading>
