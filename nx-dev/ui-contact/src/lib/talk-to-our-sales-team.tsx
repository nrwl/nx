            ...
            <div className="mx-auto mt-16 grid max-w-5xl grid-cols-1 gap-12 md:grid-cols-2 lg:gap-8">
               <section className="mt-4">
                  <p className="text-lg leading-relaxed">
                     We’re here to help you find the right plan and pricing for
                     your needs and discuss{' '}
                     <span className="font-medium">
                        how Nx Cloud Enterprise can drive better business
                        outcomes for your organization
                     </span>
                     .
                  </p>
                  <p className="mt-4 text-lg leading-relaxed">
                     Fill out the form, and we’ll get back to you to schedule a
                     call or start the discussion on a shared Slack.
                  </p>
