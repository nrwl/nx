    ...
    <section className="relative isolate px-6 py-32 sm:py-40 lg:px-8">
      ...
      <div className="mx-auto max-w-2xl text-center">
        <div className="mb-8 flex justify-center">
          <AngularIcon className="h-24 w-24 text-slate-900 dark:text-white" />
        </div>

        <h2 className="text-3xl font-medium tracking-tight text-slate-950 sm:text-5xl dark:text-white">
          Get Started With Nx Angular
        </h2>
        <p className="mt-8">
          Check out the documentation for the <code>@nx/angular</code> plugin to
          learn more
        </p>
