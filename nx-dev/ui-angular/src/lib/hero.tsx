...
import { AngularIcon } from '@nx/nx-dev/ui-icons';
      ...
      <div className="mx-auto max-w-2xl text-center">
        ...
        <div className="mb-6 flex justify-center">
          <div className="rounded-full bg-slate-100 p-4 dark:bg-slate-800">
            <AngularIcon className="h-20 w-20" />
          </div>
        </div>
        ...
        <div className="mt-10 flex flex-col items-center justify-center gap-6 sm:flex-row">
          <ButtonLink
            href="/getting-started/tutorials/angular-monorepo-tutorial"
            variant="primary"
            size="default"
            title="Get Started"
          >
            Get Started with Nx for Angular
          </ButtonLink>

          <a
            href="https://github.com/nrwl/nx-recipes/tree/main/angular-monorepo"
            target="_blank"
      ...
      <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="mt-12 grid grid-cols-1 gap-6 sm:gap-8 md:grid-cols-3 ">
          <GetStartedCard
            ...
            command="npx init nx"
            description="Initialize Nx in an existing Angular Project"
          />
          <GetStartedCard
