      ...
      <div className="flex flex-col space-y-4">
        <div className="focus-within:ring-blue-nx-base relative flex w-full overflow-hidden rounded-lg border border-slate-200 bg-white shadow-sm transition focus-within:ring-2 focus-within:ring-offset-2 hover:shadow-md dark:border-slate-700 dark:bg-slate-800">
          <div className="flex w-full flex-col px-4 py-3">
            ...
            <a
              href="https://nx.dev/cypress/overview"
              target="_blank"
              rel="noreferrer"
              title="@nrwl/cypress"
            ...
            >
              ...
              <p className="mb-8 sm:text-sm">
                Cypress is an e2e test runner built for modern web.
              </p>
              <span
                title="Official plugins are maintained by the Nx Team"
                className="absolute bottom-3 right-4 rounded-full border border-slate-200 bg-slate-50 px-3 py-0.5 text-xs font-medium capitalize dark:border-slate-700 dark:bg-slate-800 dark:bg-slate-800"
              >
                Official
              </span>
            </a>
        ...
        <div className="focus-within:ring-blue-nx-base relative flex w-full overflow-hidden rounded-lg border border-slate-200 bg-white shadow-sm transition focus-within:ring-2 focus-within:ring-offset-2 hover:shadow-md dark:border-slate-700 dark:bg-slate-800">
          <div className="flex w-full flex-col px-4 py-3">
            ...
            >
              <span className="absolute inset-0" aria-hidden="true"></span>
              <p className="mb-8 sm:text-sm">
                Contains executors and generators for managing React
                applications and libraries within an Nx workspace.
              </p>
              <span
                title="Official plugins are maintained by the Nx Team"
        ...
        <div className="focus-within:ring-blue-nx-base relative flex w-full overflow-hidden rounded-lg border border-slate-200 bg-white shadow-sm transition focus-within:ring-2 focus-within:ring-offset-2 hover:shadow-md dark:border-slate-700 dark:bg-slate-800">
          <div className="flex w-full flex-col px-4 py-3">
            ...
            >
              <span className="absolute inset-0" aria-hidden="true"></span>
              <p className="mb-8 sm:text-sm">
                Integration with libraries such as Storybook, Jest, Cypress,
                NgRx, Micro-frontend...
              </p>
              <span
                title="Official plugins are maintained by the Nx Team"
        ...
        <div className="focus-within:ring-blue-nx-base relative flex w-full overflow-hidden rounded-lg border border-slate-200 bg-white shadow-sm transition focus-within:ring-2 focus-within:ring-offset-2 hover:shadow-md dark:border-slate-700 dark:bg-slate-800">
          <div className="flex w-full flex-col px-4 py-3">
            ...
            >
              <span className="absolute inset-0" aria-hidden="true"></span>
              <p className="mb-8 sm:text-sm">
                Jest is an open source test runner created by Facebook.
              </p>
              <span
                title="Official plugins are maintained by the Nx Team"
                className="absolute bottom-3 right-4 rounded-full border border-slate-200 bg-slate-50 px-3 py-0.5 text-xs font-medium capitalize dark:border-slate-700 dark:bg-slate-800"
        ...
        <div className="focus-within:ring-blue-nx-base relative flex w-full overflow-hidden rounded-lg border border-slate-200 bg-white shadow-sm transition focus-within:ring-2 focus-within:ring-offset-2 hover:shadow-md dark:border-slate-700 dark:bg-slate-800">
          <div className="flex w-full flex-col px-4 py-3">
            ...
            >
              <span className="absolute inset-0" aria-hidden="true"></span>
              <p className="mb-8 sm:text-sm">
                Nx plugin for developing and housing .NET projects within an Nx
                workspace.
              </p>
              <span
                title="Official plugins are maintained by the Nx Team"
...
function VscodeIntegration(): JSX.Element {
  const features = [
    {
      connectionWidth: 'w-[568px]',
      name: 'Integrated UI',
...
const tabs = [
  { title: 'VSCode support', panel: VscodeIntegration },
  { title: 'Interactive Graph', panel: Graph },
  { title: 'GitHub Integration', panel: GitHubIntegration },
  { title: 'Plugins', panel: Plugins },
];
...
export function ExtensibleAndIntegrated(): JSX.Element {
  return (
    ...
    >
      ...
      <div className="relative mx-auto max-w-7xl py-12 px-4 sm:px-6 lg:px-8 lg:pb-4 lg:pt-6">
        <Tab.Group>
          <Tab.List>
            {tabs.map((tab) => (
