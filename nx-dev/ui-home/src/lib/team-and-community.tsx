      ...
      <section className="mx-auto max-w-7xl px-6 lg:px-8">
         <article className="max-w-5xl">
            ...
            <SectionHeading as="p" variant="subtitle" className="mt-6">
               Founded {yearsAgo} years ago by two <Strong>ex-Googlers</Strong>,
               our mission is to revolutionize software development with the
               power of{' '}
               <TextLink
            ...
            <SectionHeading as="p" variant="subtitle" className="mt-6">
               ...
               <Strong>bring you the best learning material</Strong> through
               various channels.
            </SectionHeading>
         </article>
