        ...
        <div className="px-4 max-w-xl mx-auto sm:px-6 lg:py-16 lg:max-w-none lg:mx-0 lg:px-0 lg:col-start-1">
          <div className="mt-6 rounded-lg border border-gray-300 bg-white shadow-md text-md text-gray-700 overflow-hidden">
            ...
            <p className="mt-4 mx-4">
              ...
              minutes, it takes the core of the Angular framework and the CLI
              and provides a more modern development experience on top of them.
            </p>
            <p className="mt-4 mx-4 italic font-medium text-gray-600">
              You get better linting, better testing, a faster CLI, mordern
              tools & support for popular community libraries and tools.
            </p>
                ...
                <div className="px-4 py-3 flex w-full">
                  <div className="flex-1 min-w-0">
                    <a href="#" className="focus:outline-none">
                      ...
                      <p className="text-xs text-gray-500">
                        Follow this guide to migrate from AngularJS to Nx step
                        by step
                      </p>
                    </a>
                  </div>
    ...
    >
      <div className="lg:mx-auto lg:max-w-7xl lg:px-8 lg:grid lg:grid-cols-2 lg:grid-flow-col-dense lg:gap-24">
        <div className="px-4 max-w-xl mx-auto sm:px-6 lg:py-16 lg:max-w-none lg:mx-0 lg:px-0 lg:col-start-1">
          <div className="mt-6 rounded-lg border border-gray-300 bg-white shadow-md text-md text-gray-700 overflow-hidden">
            <h2 className="px-4 py-3 text-lg font-semibold tracking-tight bg-gray-50 border-b border-gray-200">
              Create a Node Workspace with NestJS or Express
            </h2>
            <p className="mt-4 mx-4">
              It provides you with a standardized and integrated development
              experience for all of your Node workspaces. You get things like
              Typescript configuration and library sharing, so you can focus on
              other, more interesting development tasks.
            </p>
            <p className="mt-4 mx-4 italic font-medium text-gray-600">
              You get better linting, better testing, a faster CLI, modern tools
              & support for popular community libraries and tools, plus API
              creation using Express and Nest out of the box.
            </p>
                ...
                <div className="px-4 py-3 flex w-full">
                  <div className="flex-1 min-w-0">
                    <a href="#" className="focus:outline-none">
                      ...
                      <p className="text-xs text-gray-500">
                        Follow this guide to migrate from Lerna to Nx step by
                        step
                      </p>
                    </a>
                  </div>
      ...
      <div className="lg:mx-auto lg:max-w-7xl lg:px-8 lg:grid lg:grid-cols-2 lg:grid-flow-col-dense lg:gap-24">
        <div className="px-4 max-w-xl mx-auto sm:px-6 lg:py-16 lg:max-w-none lg:mx-0 lg:px-0 lg:col-start-1">
          <div className="mt-6 rounded-lg border border-gray-300 bg-white shadow-md text-md text-gray-700 overflow-hidden">
            ...
            <p className="mt-4 mx-4">
              With it, you can get a full-stack application up and running in
              minutes, no need to figure out source maps, webpack, test runners.
                ...
                <div className="px-4 py-3 flex w-full">
                  <div className="flex-1 min-w-0">
                    <a href="#" className="focus:outline-none">
                      ...
                      <p className="text-xs text-gray-500">
                        Follow this guide to migrate from CRA to Nx step by step
                      </p>
                    </a>
                  </div>
                  <div className="flex-shrink-0">
    ...
    >
      <div className="lg:mx-auto lg:max-w-7xl lg:px-8 lg:grid lg:grid-cols-2 lg:grid-flow-col-dense lg:gap-24">
        <div className="px-4 max-w-xl mx-auto sm:px-6 lg:py-16 lg:max-w-none lg:mx-0 lg:px-0 lg:col-start-1">
          <div className="mt-6 rounded-lg border border-gray-300 bg-white shadow-md text-md text-gray-700 overflow-hidden">
            <h2 className="px-4 py-3 text-lg font-semibold tracking-tight bg-gray-50 border-b border-gray-200">
              Create a vanilla Typescript Workspace with Nx
            </h2>
            <p className="mt-4 mx-4">
              With it, you can get a full-stack application up and running in
              minutes, no need to figure out source maps, webpack, test runners.
            ...
            <div className="relative my-6 pl-14 pr-4">
              ...
              <h3 className="mt-2 font-semibold">Vanilla Typescript </h3>

              <div className="mt-2 inline-flex">
                <InlineCommand
                  language={'bash'}
                  command={'npx create-nx-workspace --preset=none'}
                  callback={() =>
                    sendCustomEvent('code-snippets', 'click', router.pathname)
                  }
                />
