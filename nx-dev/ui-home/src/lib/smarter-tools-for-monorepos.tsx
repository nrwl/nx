         ...
         <article className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="max-w-5xl">
               ...
               <SectionHeading as="p" variant="subtitle" className="mt-6">
                  Nx plugins are{' '}
                  <Strong>
                     like VSCode extensions, but for your Nx workspace
                  </Strong>
                  . Imagine your{' '}
                  <TextLink
                  ...
                  and utilities to help you integrate your favorite
                  technologies, making working in a monorepo a much more
                  pleasant experience.
               </SectionHeading>
            </div>
