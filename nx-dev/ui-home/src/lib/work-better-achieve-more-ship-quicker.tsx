      ...
      <article className="mx-auto max-w-7xl px-6 lg:px-8">
         <div className="max-w-5xl">
            ...
            <SectionHeading as="p" variant="subtitle" className="mt-6">
               ...
               , developers ensure code stays <Strong>modular</Strong> and easy
               to maintain. By using{' '}
               <TextLink
               ...
               , developers <Strong>standardize</Strong> on best practices and
               reduce duplication. Plus, they{' '}
               <Strong>keep everything up-to-date</Strong> by using Nx's{' '}
               <TextLink
