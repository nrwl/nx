         ...
         <article className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="max-w-5xl">
               ...
               <SectionHeading as="p" variant="subtitle" className="mt-6">
                  ...
                  <Strong>hard to maintain, and unreliable</Strong>. With Nx
                  Cloud, we introduce an{' '}
                  <TextLink
                  ...
                  to making CI for monorepos not just <Strong>fast</Strong>, but
                  also <Strong>cost-efficient</Strong>. It plugs right into your
                  existing CI setup, enabling features such as{' '}
                  <TextLink
      ...
      <div className="col-span-1 h-[600px] lg:col-span-4 lg:h-[600px]">
         <Card>
            ...
            <p className="mt-2 text-slate-600 dark:text-slate-400">
               An application built for monorepo CI, so you can quickly find
               what failed, debug and move on.
            </p>
      ...
      <div className="col-span-2 h-[415px] sm:h-[360px] md:col-span-1">
         <Card>
            ...
            <p className="z-10 mt-6 text-xs text-slate-400 transition duration-200 dark:text-slate-600">
               <span className="underline">Cost per month for CI compute.</span>{' '}
         ...
         <Card>
            <div className="relative z-20">
               ...
               <p className="mt-2 max-w-md text-slate-600 dark:text-slate-400">
                  Use your current CI provider, export your compute and slash
                  your CI bill by using Nx Agents to save time, improve
                  performance and ramp-up your developer experience.
               </p>
