    ...
    <section className="relative py-16 sm:py-24">
      ...
      <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-8">
            Nx supports PHP projects using Composer and PHPUnit
          </p>
        </div>
        ...
        <div className="mt-12 grid grid-cols-1 gap-6 sm:gap-8 md:grid-cols-2 ">
          <GetStartedCard
            ...
            description="Get the <code>nx</code> executable from homebrew or <code>choco install nx-cli</code> for Windows"
          />
          <GetStartedCard
            title="Add Nx To Your Project"
            command="nx init"
            description="Select <code>@nx/php</code> when prompted."
          />

          <GetStartedCard
            title="Run Tasks With Nx"
            command="nx test <project>"
            description="Nx will automatically infer tasks from your projects."
          />
