...
export function VideoLink({ text, link }: { text: string; link: string }) {
  return (
    <div className="no-prose flex">
      ...
      >
        <div className="flex items-center justify-between space-x-2 rounded-md border border-slate-200 py-1 pl-2 pr-2 pl-3 transition hover:border-slate-500 dark:border-slate-700/40 dark:hover:border-slate-700">
          {youtubeIcon}
