   ...
   return (
      ...
      >
         ...
         >
            ...
            <span
               className={cx('ml-3 block text-sm font-medium', ui.titleColor)}
            >
               {title}
            </span>
         </span>
         <span
            className={cx('block p-4 pl-12 pt-0', collapsed ? 'hidden' : '')}
         >
            <span className={cx('prose-sm block', ui.textColor)}>
               {children}
            </span>
         </span>
      </span>
