...
export function PartnersList(): JSX.Element {
  ...
  return (
    <section>
      <div className="col-span-2 border-y border-slate-200 bg-slate-50 px-6 py-16 md:col-span-4 lg:py-24 dark:border-slate-800 dark:bg-slate-900">
        <div className="mx-auto max-w-7xl text-center">
          <div className="mx-auto max-w-3xl">
            <SectionHeading
              as="h2"
              variant="subtitle"
              className=" font-medium text-slate-950 sm:text-3xl dark:text-white"
            >
              Meet Our Partners
            </SectionHeading>
