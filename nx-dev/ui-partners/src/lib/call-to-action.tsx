    ...
    <section className="relative isolate px-6 py-32 sm:py-40 lg:px-8">
      ...
      <div className="mx-auto max-w-2xl text-center">
        ...
        <SectionDescription as="p" className="my-6 text-left">
          Are you interested in partnering with Nx? We’re always looking for
          companies and individuals to help our customers adopt and implement
          Nx. Get in touch with us to learn more about becoming a Community
          Partner.
        </SectionDescription>
