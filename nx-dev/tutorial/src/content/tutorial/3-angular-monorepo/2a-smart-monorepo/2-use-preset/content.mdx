...
The Cypress e2e task does not run in a web container. To see the e2e tests in action, download the repo and run `nx e2e angular-store-e2e` on your local machine.
