...
title: Share Code
previews:
  - { port: 4200, title: 'ReactStore', pathname: '/products' }
---
...
```file:/package.json title="/package.json" collapse={3-53} no-apply
...
We're ready to import it into our main application now. First, let's configure React Router in the `main.tsx`.
