               ...
               <div className="px-6 md:px-0 lg:pr-4 lg:pt-4">
                  <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-lg">
                     ...
                     <SectionHeading as="p" variant="subtitle" className="mt-6">
                        Nx Cloud dynamically adapts to your CI needs - providing
                        an excellent developer experience while minimizing your
                        costs.
                     </SectionHeading>
                     ...
                     <dl className="mt-12 max-w-xl space-y-4 text-base leading-7">
                        <div className="relative pl-9">
                           ...
                           <dd className="inline">
                              Instruct Nx Cloud to dynamically allocate the
                              right number of agents for each pull request.
                           </dd>
                        </div>
                        <div className="relative pl-9">
                           <dt className="inline font-semibold text-slate-950 dark:text-white">
                           ...
                           <dd className="inline">
                              Utilize additional compute from Nx Cloud and enjoy
                              faster and cheaper CI with your existing provider.
                           </dd>
                        </div>
                        <div className="relative pl-9">
                           <dt className="inline font-semibold text-slate-950 dark:text-white">
                           ...
                           <dd className="inline">
                              Add a single line to your CI configuration to
                              enable distribution, computation caching, E2E test
                              splitting, and more.
                           </dd>
                        </div>
                     </dl>
