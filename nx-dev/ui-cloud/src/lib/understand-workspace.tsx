         ...
         <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mx-auto max-w-2xl text-center">
               ...
               <SectionHeading as="p" variant="subtitle" className="mt-6">
                  Nx Cloud knows your build tools, how your projects relate to
                  each other, and what every task does.
               </SectionHeading>
            </div>
            {/*FEATURES CONTAINER*/}
...
const items = [
   {
      ...
      description: (
         <>
            ...
            initiating a distributed run on your provider, with Nx Agents
            handling the rest - streamlining operations and enhancing cost
            efficiency.
         </>
      ),
   ...
   },
   {
      ...
      description: (
         <>
            Nx Cloud splits large e2e projects into fine-grained test runs,
            enabling more efficient distribution and dramatically reducing CI
            times.
         </>
      ),
   ...
   },
   {
      ...
      description: (
         <>
            ...
            initiates a re-run of those specific tasks, optimizing resource
            usage for peak efficiency.
         </>
      ),
      header: <FlakyTasks />,
      className: 'md:col-span-1',
   ...
   },
   {
      ...
      description: (
         <>
            Nx Cloud lets you see what went wrong, and how to fix it. It
            understands your command and lets you find the logs you need.
         </>
      ),
