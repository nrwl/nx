         ...
         <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mx-auto max-w-3xl text-center">
               ...
               <SectionHeading as="p" variant="subtitle" className="mt-6">
                  With the knowledge of your workspace structure, your CI and
                  commit history, Nx Cloud can optimize CI resource usage, help
                  resolve issues, provide powerful analytics and suggest
                  refactorings.
               </SectionHeading>
            </div>
