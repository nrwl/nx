            ...
            <div>
               ...
               <div className="mt-8 flex gap-16 font-normal">
                  <p className="max-w-xl text-lg text-slate-700 dark:text-slate-400">
                     If you love Nx and want other people to love Nx too, you
                     may have the makings of an Nx Champion.
                  </p>
               </div>
            </div>
         </div>
            ...
            <dl className="grid grid-cols-1 gap-16 sm:grid-cols-2 lg:grid-cols-4">
               <div key="Recognition as a Leader" className="group">
                  ...
                  <dd className="mt-2 text-base text-slate-500 dark:text-slate-400">
                     You'll be listed in the Nx Champion directory above,
                     receive branded swag for yourself and Nx stickers to give
                     away.
                  </dd>
               </div>
               <div key="Content Promotion" className="group">
                  ...
                  <dd className="mt-2 text-base text-slate-500 dark:text-slate-400">
                     You can collaborate with other Nx Champions to improve your
                     blog posts and videos. Nx will promote your content on our
               ...
               <div key="Special Access" className="group">
                  ...
                  <dd className="mt-2 text-base text-slate-500 dark:text-slate-400">
                     You'll have a dedicated Discord channel with the Nx team
                     and monthly video calls with Nx team members to share
                     feedback and brainstorm content ideas.
                  </dd>
               </div>
               <div key="Join the Program" className="group">
                  ...
                  <dd className="mt-2 text-base text-slate-500 dark:text-slate-400">
                     ...
                     and we'll schedule an informal conversation with an Nx team
                     member to make sure the program is a good fit for you.
                  </dd>
               </div>
            </dl>
         </div>
