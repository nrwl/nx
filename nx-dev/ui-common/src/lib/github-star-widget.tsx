...
export function GitHubStarWidget({
  ...
  return (
    <div className="relative flex items-center justify-center mx-2 gap-2 rounded-md bg-slate-950 p-2 text-xs text-white transition hover:bg-slate-900 dark:bg-slate-100 dark:text-slate-950 dark:hover:bg-white print:hidden">
