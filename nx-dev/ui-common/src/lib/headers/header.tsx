        ...
        <div className="flex-shrink-0 text-sm">
          <nav className="flex items-center justify-center space-x-1">
            ...
            <a
              ...
              className="inline-flex items-center gap-1.5 px-2.5 py-1.5 text-sm font-medium rounded-md transition no-underline border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-800 text-slate-700 dark:text-slate-200 hover:bg-slate-50 dark:hover:bg-slate-700 shadow-sm"
