...
describe.each(['npm', 'yarn', 'pnpm'])(
  'nx release - independent projects - %s',
  (packageManager: 'npm' | 'yarn' | 'pnpm') => {
    ...
    beforeAll(async () => {
      ...
      setupWorkspaces(packageManager, pkg1, pkg2, pkg3);
    ...
    describe('version', () => {
      ...
      it('should support automated git operations after versioning when configured', async () => {
        ...
        expect(versionWithGitActionsCLIOutput).toMatchSnapshot();
      ...
      `);
        ...
        expect(versionWithGitActionsConfigOutput).toMatchSnapshot();
