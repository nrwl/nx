...
| Version admission         | A new upstream major just needs to be allowed                                                           | `packageJsonUpdates` group gated on the source-major window (see `packages/storybook/migrations.json` key `22.1.0`)                                                                                          |
