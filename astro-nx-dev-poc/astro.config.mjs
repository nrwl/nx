	...
	integrations: [
		starlight({
			...
			social: [
				...
				{ icon: 'youtube', label: 'YouTube', href: 'https://www.youtube.com/@NxDevtools?utm_source=nx.dev' },
				{ icon: 'x.com', label: 'X', href: 'https://x.com/NxDevTools?utm_source=nx.dev' },
				{ icon: 'discord', label: 'Discord', href: 'https://go.nx.dev/community' },
			],
			editLink: {
