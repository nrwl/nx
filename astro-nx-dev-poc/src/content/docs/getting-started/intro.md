...
Card title="Get set up and ready with Nx" href="/getting-started">
...
Card title="Dive deep into Nx features" href="/features">
Discover all the powerful features that Nx provides to streamline your
workflow

Card title="Understand underlying concepts" href="/concepts">
Improve your understanding of the core concepts of how Nx works under the
hood

Card title="Explore Technologies" href="/technologies">
Explore Nx's technology integrations and how it can support your specific
stack
