...
const matchCommit = /(chore|feat|fix|cleanup|docs)\((angular|bazel|core|docs|nextjs|nest|node|nx-plugin|react|storybook|testing|repo|misc)\):\s(([a-z0-9:\-\s])+)/g.test(
  gitMessage
);
...
if (exitCode === 0) {
  ...
  console.log(
    'possible scopes: angular|bazel|core|docs|nextjs|nest|node|react|storybook|testing|repo|misc (if unsure use "core")'
  );
  console.log(
    '\nEXAMPLE: \n' +
