...
There is also a [repo](https://github.com/jaysoo/migrate-cra-to-nx) that shows the finished result of this guide and for each step a [diff](https://github.com/isaacplmann/migrate-cra-to-nx/commits/stepbystep) will be provided to see the exact code changes that occur for that step.
...
[View the code changes](https://github.com/isaacplmann/migrate-cra-to-nx/commit/3f2a00924e1c7e42875493f9d71b067d7ca69fe1)
...
[View the code changes](https://github.com/isaacplmann/migrate-cra-to-nx/commit/31fa9a327a939abe0fa420130760bde974b2f6fe)
...
[View the code changes](https://github.com/isaacplmann/migrate-cra-to-nx/commit/a8ad934998949a760e5b62782689683cb469dd7c)

## 4. Add CRA commands to workspace.json

Find the `webapp` section inside `/workspace.json` and replace it with the following text. The `architect` section defines commands that can be executed by Nx and what Nx should do when those commands are triggered. The [run-commands](/{{framework}}/plugins/workspace/builders/run-commands) builder executes a terminal command. `cwd` specifies the directory the command should be executed from and `outputs` lets Nx know which files are modified when the command is executed.
...
[View the code changes](https://github.com/isaacplmann/migrate-cra-to-nx/commit/009266330cc0c158372c0ae527cdd3dc66a43d13)
...
[View the code changes](https://github.com/isaacplmann/migrate-cra-to-nx/commit/5e514e0708365d2373a73c2828936eba594789b5)
...
[View the code changes](https://github.com/isaacplmann/migrate-cra-to-nx/commit/49c515ad8a497c347b1c0292d7fde24bf4d0807c)
...
[View the code changes](https://github.com/isaacplmann/migrate-cra-to-nx/commit/a70a545d9574bbc300b0a8ace123f75313e9d869)
...
[View the code changes](https://github.com/isaacplmann/migrate-cra-to-nx/commit/cbff423fab73d967bb21d54f2188d77166bd919c)
...
[View the code changes](https://github.com/isaacplmann/migrate-cra-to-nx/commit/9c02fcda2f39cf3b29ceab75d0c519b9b1b333ba)
...
[View the code changes](https://github.com/isaacplmann/migrate-cra-to-nx/commit/d8b0e3ac2b8ca10ff6b24ccfdecc637407a2ff2d)
...
[View the code changes](https://github.com/isaacplmann/migrate-cra-to-nx/commit/cfb1d6170c72cfd9355d16fefc045527683fc604)
