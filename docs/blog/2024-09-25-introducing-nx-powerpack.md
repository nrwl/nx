...
Open source projects can continue to use Nx Cloud for **free** the same way they always have, and they can continue to use Nx with all its features. If you are an open-source maintainer and you want to use Powerpack, you will get a **free license**. Just reach out to us at [powerpack-support@nrwl.io](/company).
...
In a monorepo you reason based on projects. That's what you pass to your [Nx run commands](/docs/features/run-tasks), what you see on the [project graph](/docs/features/explore-graph) and also where owners should be defined. To get started install the Codeowners Powerpack plugin:
