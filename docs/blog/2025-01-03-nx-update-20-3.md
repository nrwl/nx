...
authors: [Zack DeRose]
tags: [nx]
cover_image: /blog/images/2025-01-03/nx-20-3.png
---
...
- [Angular 19 and React 19 Support](#angular-19-and-react-19-support)
...
## Angular 19 and React 19 Support
...
Nx now also supports [React v19](https://react.dev/blog/2024/12/05/react-19) - in the sense that you when you create a new workspace with a `react` preset, we'll use version 19. Migrations to React 19 are not yet supported due to complications with third-party dependencies, but you can still complete the migration manually by updating your packages in your `project.json`, and after this, all of our `@nx/react` and `@nx/next` generators will still work. We will continue to investigate an automated migration to React 19.

The react team has also published [codemods](https://react.dev/blog/2024/04/25/react-19-upgrade-guide#codemods) to assist in the React 18 => 19 migration.

## Core Performance Improvements

Over the past many months, we've addressed most of the glaring issues regarding the new ['inferred tasks plugins'](https://nx.dev/concepts/inferred-tasks) that were first introduced in Nx v18. Now, in the last recent months, we've started to address some of the more fine-grained issues that we has seen in supporting this new functionality - including performance.
...
We've also added the capability to allow folks to authenitcate their PowerPack license via Nx Cloud (rather than requiring that the license be committed to the repository). This should enable oss library authors use PowerPack - without exposing their private license via their repo.
