...
description: 'Explore insights from Nx Champion Tine Kondo on monorepo benefits and the potential of the Nx plugin for Gradle for Java development.'
---
...
In particular, Nx's new plugin: [@nx/gradle](/docs/technologies/java/introduction) is of interest, and Tine provides some valuable insight on the impact this plugin can make, as well as the importance for Maven support.
