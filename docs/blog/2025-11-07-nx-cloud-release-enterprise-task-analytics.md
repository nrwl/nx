---
title: 'Nx Cloud Release: Introducing Enterprise Task Analytics'
...
Enterprise Task Analytics is available **today** for all of our Nx Enterprise customers on our multi-tenant instance with no setup required. Head to the Analytics section in one of your workspaces, and you’ll see two new tabs: **Tasks** and **Flaky Tasks**.

{% call-to-action size="lg" title="Experience Task Analytics today!" url="https://cloud.nx.app/go/workspace/analytics/tasks" icon="nxcloud" description="Available for all multi-tenant Nx Enterprise customers." /%}

Other environments will have access soon, reach out to your DPE for details.

[Nx Enterprise](/enterprise) is our solution to enable large organizations ship like a startup. In addition to Task Analytics, you’ll also get insight into your organization with [Polygraph](/docs/enterprise/polygraph) tools like:
...
{% call-to-action size="lg" title="Schedule a free trial today!" url="/enterprise/trial" icon="nxcloud" description="Let's talk about how Nx Enterprise and Task Analytics can transform your platform health." /%}
...
- 👩‍💻 [Flaky Task Analytics docs](/docs/features/ci-features/flaky-tasks#flaky-task-analytics)
