...
We're super excited to have launched "Nx Agents" to Early Access. If you haven't seen Victor's video yet about how he reduced e2e tests from 90 minutes to 10, then make sure to [check it out](/docs/features/ci-features/distribute-task-execution).
...
Updating Nx and its plugins is easy as we ship an [automated migration command](/docs/features/automate-updating-dependencies).
