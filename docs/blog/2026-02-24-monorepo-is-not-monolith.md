...
_For the examples in this post, I will use [Nx](https://nx.dev), an extensible build system optimized for monorepos. But the concepts apply broadly to any monorepo tooling._
