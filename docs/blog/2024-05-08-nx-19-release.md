...
As a note, if you cannot see `e2e-ci` tasks after converting your cypress projects, you can [take a closer look here](/docs/technologies/test-tools/cypress/introduction#splitting-e2e-tasks-by-file) at how to configure them correctly.
...
In February, we launched two big enhancements to Nx Cloud: the [Atomizer](/docs/features/ci-features/split-e2e-tasks) and [Nx Agents](https://nx.app/products/agents#content).
