...
When using the Test Atomizer features of plugins like [`@nx/playwright`](/nx-api/playright) and [`@nx/cypress`](/nx-api/cypress), you end up creating tasks with dynamic but predictable names.
