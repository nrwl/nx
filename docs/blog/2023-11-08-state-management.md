...
- Official @nx/expo plugin: [/nx-api/expo](/technologies/react/expo/api)
- Official @nx/react-native plugin: [/nx-api/react-native](/technologies/react/react-native/api)
