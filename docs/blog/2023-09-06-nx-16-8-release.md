...
This is where our new `[convert-to-monorepo](https://nx.dev/packages/workspace/generators/convert-to-monorepo)` [generator](https://nx.dev/packages/workspace/generators/convert-to-monorepo) comes into play!
...
Our docs site has hosted [a registry of these plugins](https://nx.dev/extending-nx/registry) for awhile now, but we’ve recently added npm downloads, github stars, release dates, and compatible Nx versions to this registry:
...
Go [check it out now](https://nx.dev/extending-nx/registry) live on our docs site!

## DOCS ENHANCEMENT: Redesigned Intro & Examples

Our mission to improve Nx docs continues: this edition with some major updates to our [Docs intro page](https://nx.dev/docs).

We improved the messaging around Nx and more prominently emphasizing the [core features](https://nx.dev/core-features) that distinguish Nx from other tools out there. We also linked a new “What is Nx” video. You should check it out 🐐
...
You can find all of the examples and more on our “Showcase” section: [https://nx.dev/showcase](https://nx.dev/showcase).
...
As part of our continued support for ESLint, we’ve introduced [a new generator](https://nx.dev/packages/linter/generators/convert-to-flat-config) to convert your Nx monorepo to this new system:
...
Be sure to checkout the [Nx Cloud landing site](https://nx.app/) for more details on all the additional features you unlock with the power of the cloud!

## Nx Conf Coming Up

Last but definitely not least, [Nx Conf 2023](https://nx.dev/conf) is fast approaching! We’ll be coming to you live from New York City on September 26!

Be sure to [register to attend online FOR FREE](https://ti.to/nx-conf/nxconf2023online) and be sure to checkout our [lineup of talks](https://nx.dev/conf#agenda) and [speakers](https://nx.dev/conf#speakers)!
