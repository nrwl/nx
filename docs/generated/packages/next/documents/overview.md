...
For more information on Nx libraries, see our documentation on [Creating Libraries](/concepts/decisions/creating-libraries)
and [Library Types](/concepts/decisions/library-types).
