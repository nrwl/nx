...
| `name`                | `string`                                                                        | -                                                                                                                                             |
| `onComplete?`         | [`OnComplete`](../../devkit/documents/OnComplete)\<`TOptions`\>                 | Called after the project graph is constructed                                                                                                 |
| `onLoad?`             | [`OnLoad`](../../devkit/documents/OnLoad)\<`TOptions`\>                         | Called when the plugin is loaded.                                                                                                             |
