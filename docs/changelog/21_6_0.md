...
{% card title="AI Configuration Command" type="document" url="/features/automate-updating-dependencies" /%}
{% card title="Unified Graph UI and Controls" type="document" url="/features/explore-graph" /%}
{% card title="Enhanced Playwright Test Atomization" type="document" url="/technologies/test-tools/playwright/guides/merge-atomized-outputs" /%}
{% /cards %}
