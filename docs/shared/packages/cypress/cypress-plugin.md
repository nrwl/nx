...
You can run your e2e test against a production build by using the `production` [configuration](https://nx.dev/features/enhance-tooling#use-executor-configurations)
