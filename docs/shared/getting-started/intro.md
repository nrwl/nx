...
{% link-card title="TypeScript Monorepo" type="tutorial" url="/tutorials/1-ts-packages/1t-introduction/1-welcome" icon="jsMono" /%}

{% link-card title="React Monorepo" type="tutorial" url="/tutorials/2-react-monorepo/1r-introduction/1-welcome" icon="reactMono" /%}

{% link-card title="Angular Monorepo" type="tutorial" url="/tutorials/3-angular-monorepo/1a-introduction/1-welcome" icon="angularMono" /%}

{% link-card title="Gradle Monorepo" type="tutorial" url="/tutorials/4-gradle/1g-introduction/1-welcome" icon="gradle" /%}
