- Nx
  ...
  - [Technologies](/technologies)
    ...
    - [Angular](/technologies/angular)
      - [Core](/technologies/angular/core)
        - [Introduction](/technologies/angular/core/introduction)
        - [Migration](/technologies/angular/core/migration)
          - [Migrating from Angular CLI](/technologies/angular/core/migration/angular)
          - [Migrating From Multiple Angular CLI Repos](/technologies/angular/core/migration/angular-multiple)
        - [Recipes](/technologies/angular/core/recipes)
          - [Use Environment Variables in Angular](/technologies/angular/core/recipes/use-environment-variables-in-angular)
          - [Using Tailwind CSS with Angular projects](/technologies/angular/core/recipes/using-tailwind-css-with-angular-projects)
          - [Setup Module Federation with SSR for Angular](/technologies/angular/core/recipes/module-federation-with-ssr)
          - [Advanced Micro Frontends with Angular using Dynamic Federation](/technologies/angular/core/recipes/dynamic-module-federation-with-angular)
          - [Setup incremental builds for Angular applications](/technologies/angular/core/recipes/setup-incremental-builds-angular)
        - [API](/technologies/angular/core/api)
    ...
    - [React](/technologies/react)
      - [Core](/technologies/react/core)
        - [Introduction](/technologies/react/core/introduction)
        - [Recipes](/technologies/react/core/recipes)
          - [React Native with Nx](/technologies/react/core/recipes/react-native)
          - [Remix with Nx](/technologies/react/core/recipes/remix)
          - [React Router with Nx](/technologies/react/core/recipes/react-router)
          - [Use Environment Variables in React](/technologies/react/core/recipes/use-environment-variables-in-react)
          - [Using Tailwind CSS in React](/technologies/react/core/recipes/using-tailwind-css-in-react)
          - [Adding Images, Fonts, and Files](/technologies/react/core/recipes/adding-assets-react)
          - [Setup Module Federation with SSR for React](/technologies/react/core/recipes/module-federation-with-ssr)
          - [Deploying Next.js applications to Vercel](/technologies/react/core/recipes/deploy-nextjs-to-vercel)
          - [React Compiler with Nx](/technologies/react/core/recipes/react-compiler)
        - [API](/technologies/react/core/api)
    ...
    - [Vue](/technologies/vue)
      - [Core](/technologies/vue/core)
        - [Introduction](/technologies/vue/core/introduction)
        - [Recipes](/technologies/vue/core/recipes)
        - [API](/technologies/vue/core/api)
    ...
    - [Node.js](/technologies/nodejs)
      - [Core](/technologies/nodejs/core)
        - [Introduction](/technologies/nodejs/core/introduction)
        - [Recipes](/technologies/nodejs/core/recipes)
          - [Deploying a Node App to Fly.io](/technologies/nodejs/core/recipes/node-server-fly-io)
          - [Add and Deploy Netlify Edge Functions with Node](/technologies/nodejs/core/recipes/node-serverless-functions-netlify)
          - [Deploying AWS lambda in Node.js (deprecated)](/technologies/nodejs/core/recipes/node-aws-lambda)
          - [Set Up Application Proxies](/technologies/nodejs/core/recipes/application-proxies)
          - [Wait for Tasks to Finish](/technologies/nodejs/core/recipes/wait-for-tasks)
        - [API](/technologies/nodejs/core/api)
      - [Express](/technologies/nodejs/express)
        - [Introduction](/technologies/nodejs/express/introduction)
        - [API](/technologies/nodejs/express/api)
      - [Nest](/technologies/nodejs/nest)
        - [Introduction](/technologies/nodejs/nest/introduction)
        - [API](/technologies/nodejs/nest/api)
    ...
    - [ESLint](/technologies/eslint-technology)
      - [Introduction](/technologies/eslint-technology/introduction)
      - [Recipes](/technologies/eslint-technology/recipes)
        - [Configuring ESLint with Typescript](/technologies/eslint-technology/recipes/eslint)
        - [Switching to ESLint's flat config format](/technologies/eslint-technology/recipes/flat-config)
      - [API](/technologies/eslint-technology/api)
    - [ESLint Package](/nx-api/eslint)
    - [ESLint Plugin Package](/nx-api/eslint-plugin)
    - [The enforce-module-boundaries rule](/nx-api/eslint-plugin)
    - [The dependency-checks rule](/nx-api/eslint-plugin)
    ...
    - [Testing Tools](/technologies/testing-tools)
      - [Cypress](/technologies/testing-tools/cypress)
        - [Introduction](/technologies/testing-tools/cypress/introduction)
        - [Recipes](/technologies/testing-tools/cypress/recipes)
          - [Component Testing](/technologies/testing-tools/cypress/recipes/cypress-component-testing)
          - [Using setupNodeEvents with Cypress preset](/technologies/testing-tools/cypress/recipes/cypress-setup-node-events)
          - [Cypress v11 Migration Guide](/technologies/testing-tools/cypress/recipes/cypress-v11-migration)
        - [API](/technologies/testing-tools/cypress/api)
      - [Jest](/technologies/testing-tools/jest)
        - [Introduction](/technologies/testing-tools/jest/introduction)
        - [Recipes](/technologies/testing-tools/jest/recipes)
        - [API](/technologies/testing-tools/jest/api)
      - [Playwright](/technologies/testing-tools/playwright)
        - [Introduction](/technologies/testing-tools/playwright/introduction)
        - [Recipes](/technologies/testing-tools/playwright/recipes)
        - [API](/technologies/testing-tools/playwright/api)
      - [Storybook](/technologies/testing-tools/storybook)
        - [Introduction](/technologies/testing-tools/storybook/introduction)
        - [Recipes](/technologies/testing-tools/storybook/recipes)
          - [Set up Storybook for React Projects](/technologies/testing-tools/storybook/recipes/overview-react)
          - [Set up Storybook for Angular Projects](/technologies/testing-tools/storybook/recipes/overview-angular)
          - [Set up Storybook for Vue Projects](/technologies/testing-tools/storybook/recipes/overview-vue)
          - [Configuring Storybook on Nx](/technologies/testing-tools/storybook/recipes/configuring-storybook)
          - [One main Storybook instance for all projects](/technologies/testing-tools/storybook/recipes/one-storybook-for-all)
          - [One Storybook instance per scope](/technologies/testing-tools/storybook/recipes/one-storybook-per-scope)
          - [One main Storybook instance using Storybook Composition](/technologies/testing-tools/storybook/recipes/one-storybook-with-composition)
          - [How to configure Webpack and Vite for Storybook](/technologies/testing-tools/storybook/recipes/custom-builder-configs)
          - [Setting up Storybook Interaction Tests with Nx](/technologies/testing-tools/storybook/recipes/storybook-interaction-tests)
          - [Upgrading Storybook using the Storybook CLI](/technologies/testing-tools/storybook/recipes/upgrading-storybook)
          - [Setting up Storybook Composition with Nx](/technologies/testing-tools/storybook/recipes/storybook-composition-setup)
          - [Angular: Set up Compodoc for Storybook on Nx](/technologies/testing-tools/storybook/recipes/angular-storybook-compodoc)
          - [Angular: Configuring styles and preprocessor options](/technologies/testing-tools/storybook/recipes/angular-configuring-styles)
        - [API](/technologies/testing-tools/storybook/api)
      - [Detox](/technologies/testing-tools/detox)
        - [Introduction](/technologies/testing-tools/detox/introduction)
        - [Recipes](/technologies/testing-tools/detox/recipes)
        - [API](/technologies/testing-tools/detox/api)
  - [Concepts](/concepts)
