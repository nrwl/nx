- Nx
  ...
  - [Technologies](/technologies)
    ...
    - [Node.js](/technologies/nodejs)
      - [Introduction](/technologies/nodejs/introduction)
      - [Recipes](/technologies/nodejs/recipes)
        - [Deploying a Node App to Fly.io](/technologies/nodejs/recipes/node-server-fly-io)
        - [Add and Deploy Netlify Edge Functions with Node](/technologies/nodejs/recipes/node-serverless-functions-netlify)
        - [Deploying AWS lambda in Node.js (deprecated)](/technologies/nodejs/recipes/node-aws-lambda)
        - [Set Up Application Proxies](/technologies/nodejs/recipes/application-proxies)
        - [Wait for Tasks to Finish](/technologies/nodejs/recipes/wait-for-tasks)
      - [API](/technologies/nodejs/api)
