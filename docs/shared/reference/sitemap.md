...
- Recipes
  ...
  - [Angular](/recipes/adopting-nx-angular)
    - [Migrating Angular CLI](/recipes/adopting-nx-angular/migration-angular)
    - [Migrating Angular CLI to Integrated](/recipes/adopting-nx-angular/angular-integrated)
    - [Migrating Angular Manually](/recipes/adopting-nx-angular/angular-manual)
    - [Migrate Multiple Angular Repos](/recipes/adopting-nx-angular/angular-multiple)
    - [Migrate AngularJS](/recipes/adopting-nx-angular/migration-angularjs)
    ...
    - [Standalone NgRx APIs](/recipes/adopting-nx-angular/standalone-ngrx-apis)
