  ...
  - [Recipes](/recipes)
    ...
    - [Angular](/recipes/angular)
      - [Angular Rspack](/recipes/angular/rspack)
        ...
        - [API Reference](/recipes/angular/rspack/api-reference)
          - [@ng-rspack/build](/recipes/angular/rspack/api-reference/ng-rspack-build)
            - [createConfig](/recipes/angular/rspack/api-reference/ng-rspack-build/create-config)
            - [createServer](/recipes/angular/rspack/api-reference/ng-rspack-build/create-server)
          - [@ng-rsbuild/plugin-angular](/recipes/angular/rspack/api-reference/ng-rsbuild-plugin-angular)
            - [createConfig](/recipes/angular/rspack/api-reference/ng-rsbuild-plugin-angular/create-config)
            - [createServer](/recipes/angular/rspack/api-reference/ng-rsbuild-plugin-angular/create-server)
            - [withConfigurations](/recipes/angular/rspack/api-reference/ng-rsbuild-plugin-angular/with-configurations)
