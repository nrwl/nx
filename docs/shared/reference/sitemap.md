...
- Cloud
  ...
  - [Concepts](/nx-cloud/concepts)
    - [Faster CI with Nx](/nx-cloud/concepts/faster-ci)
  ...
  - [Recipes](/nx-cloud/recipes)
    ...
    - [Security](/nx-cloud/recipes/security)
      - [Authenticate with Google Identity](/nx-cloud/recipes/security/google-auth)
      - [Access Tokens](/nx-cloud/recipes/security/access-tokens)
