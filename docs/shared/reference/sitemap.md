...
- Packages
  ...
  - [vue](/packages/vue)
    - [documents](/packages/vue/documents)
      - [Overview of the Nx Vue Plugin](/packages/vue/documents/overview)
    - [generators](/packages/vue/generators)
      - [init](/packages/vue/generators/init)
      - [application](/packages/vue/generators/application)
      - [library](/packages/vue/generators/library)
      - [component](/packages/vue/generators/component)
      - [setup-tailwind](/packages/vue/generators/setup-tailwind)
  - [web](/packages/web)
