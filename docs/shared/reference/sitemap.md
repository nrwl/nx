  ...
  - [Technologies](/technologies)
    ...
    - [ESLint](/technologies/eslint)
      ...
      - [ESLint Plugin](/technologies/eslint/eslint-plugin)
        ...
        - [documents](/technologies/eslint-plugin/api/documents)
          - [Overview](/technologies/eslint-plugin/api/documents/overview)
          - [The `enforce-module-boundaries` rule](/technologies/eslint-plugin/api/documents/enforce-module-boundaries)
          - [The `dependency-checks` rule](/technologies/eslint-plugin/api/documents/dependency-checks)
    ...
    - [Test Tools](/technologies/test-tools)
      ...
      - [Storybook](/technologies/test-tools/storybook)
        ...
        - [documents](/technologies/storybook/api/documents)
          - [Overview](/technologies/storybook/api/documents/overview)
          - [Storybook best practices for making the most out of Nx](/technologies/storybook/api/documents/best-practices)
          - [Storybook 7](/technologies/storybook/api/documents/storybook-7-setup)
...
- Nx-api
  ...
  - [cypress](/nx-api/cypress)
    - [documents](/nx-api/cypress/documents)
      - [Overview](/technologies/cypress/api/documents/overview)
  ...
  - [detox](/nx-api/detox)
    - [documents](/nx-api/detox/documents)
      - [Overview](/technologies/detox/api/documents/overview)
  ...
  - [esbuild](/nx-api/esbuild)
    - [documents](/nx-api/esbuild/documents)
      - [Overview](/technologies/esbuild/api/documents/overview)
  ...
  - [eslint](/nx-api/eslint)
    - [documents](/nx-api/eslint/documents)
      - [Overview](/technologies/eslint/api/documents/overview)
  ...
  - [expo](/nx-api/expo)
    - [documents](/nx-api/expo/documents)
      - [Overview](/technologies/expo/api/documents/overview)
  ...
  - [express](/nx-api/express)
    - [documents](/nx-api/express/documents)
      - [Overview](/technologies/express/api/documents/overview)
  ...
  - [gradle](/nx-api/gradle)
    - [documents](/nx-api/gradle/documents)
      - [Overview](/technologies/java/api/documents/overview)
  ...
  - [jest](/nx-api/jest)
    - [documents](/nx-api/jest/documents)
      - [Overview](/technologies/jest/api/documents/overview)
  ...
  - [js](/nx-api/js)
    - [documents](/nx-api/js/documents)
      - [Overview](/technologies/typescript/api/documents/overview)
  ...
  - [nest](/nx-api/nest)
    - [documents](/nx-api/nest/documents)
      - [Overview](/technologies/nest/api/documents/overview)
  ...
  - [next](/nx-api/next)
    - [documents](/nx-api/next/documents)
      - [Overview](/technologies/next/api/documents/overview)
  ...
  - [node](/nx-api/node)
    - [documents](/nx-api/node/documents)
      - [Overview](/technologies/node/api/documents/overview)
  ...
  - [nuxt](/nx-api/nuxt)
    - [documents](/nx-api/nuxt/documents)
      - [Overview](/technologies/nuxt/api/documents/overview)
  ...
  - [playwright](/nx-api/playwright)
    - [documents](/nx-api/playwright/documents)
      - [Overview](/technologies/playwright/api/documents/overview)
  ...
  - [plugin](/nx-api/plugin)
    - [documents](/nx-api/plugin/documents)
      - [Overview](/reference/core-api/plugin/documents/overview)
  ...
  - [react](/nx-api/react)
    - [documents](/nx-api/react/documents)
      - [Overview](/technologies/react/api/documents/overview)
  ...
  - [react-native](/nx-api/react-native)
    - [documents](/nx-api/react-native/documents)
      - [Overview](/technologies/react-native/api/documents/overview)
  ...
  - [remix](/nx-api/remix)
    - [documents](/nx-api/remix/documents)
      - [Overview](/technologies/remix/api/documents/overview)
  ...
  - [rspack](/nx-api/rspack)
    - [documents](/nx-api/rspack/documents)
      - [Overview](/technologies/rspack/api/documents/overview)
  ...
  - [vite](/nx-api/vite)
    - [documents](/nx-api/vite/documents)
      - [Overview](/technologies/vite/api/documents/overview)
  ...
  - [vue](/nx-api/vue)
    - [documents](/nx-api/vue/documents)
      - [Overview](/technologies/vue/api/documents/overview)
  ...
  - [web](/nx-api/web)
    - [documents](/nx-api/web/documents)
      - [Overview](/reference/core-api/web/documents/overview)
  ...
  - [webpack](/nx-api/webpack)
    - [documents](/nx-api/webpack/documents)
      - [Overview](/technologies/webpack/api/documents/overview)
