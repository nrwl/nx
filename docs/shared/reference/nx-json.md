...
| cacheDirectory             | defines where the local cache is stored (defaults to `node_modules/.cache/nx`). This seting will be overwritten by NX_CACHE_DIRECTORY environment variable.                                                                                                                                                                                   |
| projectGraphCacheDirectory | defines where the cache of project graph and daemon logging is stored (defaults to the cacheDirectory setting above) This seting will be overwritten by NX_PROJECT_GRAPH_CACHE_DIRECTORY environment variable.                                                                                                                                |
