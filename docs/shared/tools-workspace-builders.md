...
This guide will show you how and create, run and customize builders within your Nx workspace. In the examples, we'll use the trivial use-case of an `echo` command.
...
Part of the power of the architect API is the ability to compose builders via JS functional composition, where you can combine other builders from your workspace into one which could be helpful when the process you’re scripting is a combination of other existing builders provided by the CLI or other custom-builders in your workspace.
