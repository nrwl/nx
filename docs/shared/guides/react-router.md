...
React Router is the successor of Remix and is the recommended routing library for new projects.

In this recipe, we'll show you how to create a [React Router](https://reactrouter.com/home) application with Nx.
...
2. To serve your application for development use the following command:
...
3. To serve your application's production build use the following command:
...
4. To test the application run the following command:
