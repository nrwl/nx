...
- `NODE_ENV`
- Variables prefixed with `NX_PUBLIC`, such as `NX_PUBLIC_CUSTOM_VAR` (when using the [NxAppWebpackPlugin](/technologies/build-tools/webpack/recipes/webpack-plugins#nxappwebpackplugin) or the [withNx](/technologies/build-tools/webpack/recipes/webpack-plugins#withnx) plugins)
...
This feature is available when using the [NxAppWebpackPlugin](/technologies/build-tools/webpack/recipes/webpack-plugins#nxappwebpackplugin) or the [withNx](/technologies/build-tools/webpack/recipes/webpack-plugins#withnx) plugins.
