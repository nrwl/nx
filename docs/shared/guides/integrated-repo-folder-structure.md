...
`/tools/` contains scripts that act on your code base. This could be database scripts, [local executors](/plugins/executors/creating-custom-executors), or [local generators](/plugins/generators/local-generators).
