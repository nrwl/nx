...
1. Make sure that the task is in [cacheableOperations](/core-features/cache-task-results)

2. Check if the output of your task is changing the inputs of your task
...
3. Use the Nx Cloud troubleshooting tools
