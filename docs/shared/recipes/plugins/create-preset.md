...
All first-party Nx presets are built into nx itself, but you can [create your own plugin](/plugin-features/create-your-own-plugin) and create a generator with the magic name: `preset`. Once you've [published your plugin](/plugins/advanced/share-your-plugin) on npm, you can now run. the create-nx-workspace command with the preset option set to the name of your published package.
