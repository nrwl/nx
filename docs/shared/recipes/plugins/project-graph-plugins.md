...
2. If you create a dynamic target for an executor you don't own, only define the `executor` property and instruct your users to define their options in the `defaultTargets` property of `nx.json`. The code would look something like this:
