...
Nx Console has a button which will show a preview of this screen when a project level configuration file (`project.json` or `package.json`) is opened in the IDE. See more at [Nx Console Project Details View](/recipes/nx-console/console-project-details).
