...
> If you need to test only the collection ngrx test [for example], you can use an optional `$1` argument; like `yarn test:schematics schematics/src/collection/ngrx/ngrx`
