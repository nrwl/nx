...
> If you need to test only the **collection/ngrx.spec.ts** test [for example], you can use an optional `$1` argument as follows:<br/> `yarn test:schematics schematics/src/collection/ngrx/ngrx`
