            ...
            targets: {
               ...
               jar: {
                  options: {
                     cwd: 'utilities',
                     command:
                        '/Users/emily/code/tmp/gradle-plugin-test3/gradlew jar',
                  },
                  cache: true,
                  executor: 'nx:run-commands',
                  configurations: {},
               ...
               help: {
                  options: {
                     cwd: 'utilities',
                     command:
                        '/Users/emily/code/tmp/gradle-plugin-test3/gradlew help',
                  },
                  cache: false,
                  executor: 'nx:run-commands',
                  configurations: {},
               ...
               test: {
                  options: {
                     cwd: 'utilities',
                     command:
                        '/Users/emily/code/tmp/gradle-plugin-test3/gradlew test',
                  },
                  cache: true,
                  inputs: ['default', '^default'],
                  dependsOn: ['classes'],
            ...
            targets: {
               ...
               'e2e-ci--src/e2e/app.cy.ts': {
                  ...
                  metadata: {
                     technologies: ['cypress'],
                     description:
                        'Runs Cypress Tests in src/e2e/app.cy.ts in CI',
                  },
                  executor: 'nx:run-commands',
                  configurations: {},
               },
