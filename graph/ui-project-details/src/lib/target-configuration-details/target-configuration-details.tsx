                  ...
                  <>
                     <h4 className="mb-4">
                        <Tooltip
                           openAction="hover"
                           content={
                              (<PropertyInfoTooltip type="options" />) as any
                           }
                        >
                  ...
                  <div className="group">
                     <h4 className="mb-4">
                        <Tooltip
                           openAction="hover"
                           content={
                              (<PropertyInfoTooltip type="inputs" />) as any
                           }
                        >
                           <span className="font-medium">
                  ...
                  <div className="group">
                     <h4 className="mb-4">
                        <Tooltip
                           openAction="hover"
                           content={
                              (<PropertyInfoTooltip type="outputs" />) as any
                           }
                        >
                           <span className="font-medium">
                  ...
                  <div className="group">
                     <h4 className="mb-4">
                        <Tooltip
                           openAction="hover"
                           content={
                              (<PropertyInfoTooltip type="dependsOn" />) as any
                           }
                        >
                           <span className="font-medium">
                              <TooltipTriggerText>
                  ...
                  <>
                     <h4 className="mb-4 py-2">
                        <Tooltip
                           ...
                           content={
                              (
                                 <PropertyInfoTooltip type="configurations" />
                              ) as any
                           }
                        >
                           <span className="font-medium">
                  ...
                  <div className="group mb-4">
                     <h4 className="mb-4">
                        <Tooltip
                           ...
                           content={
                              (
                                 <PropertyInfoTooltip type="parallelism" />
                              ) as any
                           }
                        >
                           <span className="font-medium">
